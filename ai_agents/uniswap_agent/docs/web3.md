<page>
  <title>Quickstart — web3.py 7.7.0 documentation</title>
...
[Installation](#id2)[](#installation "Link to this heading")
-------------------------------------------------------------
...
[Using Web3](#id3)[](#using-web3 "Link to this heading")
---------------------------------------------------------
...
### [Test Provider](#id4)[](#test-provider "Link to this heading")
...
### [Local Providers](#id5)[](#local-providers "Link to this heading")
...
### [Remote Providers](#id6)[](#remote-providers "Link to this heading")
...
[Getting Blockchain Info](#id7)[](#getting-blockchain-info "Link to this heading")
-----------------------------------------------------------------------------------
...
*   The [Overview](https://web3py.readthedocs.io/en/stable/overview.html) page provides a summary of web3.py’s features.
...
<page>
  <title>gm — web3.py 7.7.0 documentation</title>
...
0.  Don’t travel alone! Join the Ethereum Python Community [Discord](https://discord.gg/GHryRvPB84).
...
*   Ready to code? → [Quickstart](https://web3py.readthedocs.io/en/stable/quickstart.html#quickstart)
    
*   Quick tour? → [Overview](https://web3py.readthedocs.io/en/stable/overview.html#overview)
    
*   Synchronous help? → [Discord](https://discord.gg/GHryRvPB84)
    
*   Asynchronous help? → [StackExchange](https://ethereum.stackexchange.com/questions/tagged/web3.py)
    
*   Report a bug? → [Github](https://github.com/ethereum/web3.py/issues)
    
*   Want to help us? → [Contribute](https://web3py.readthedocs.io/en/stable/contributing.html#contributing)
    
*   Looking for inspiration? → [Resources and Learning Material](https://web3py.readthedocs.io/en/stable/resources.html#resources)
...
<page>
  <title>Providers — web3.py 7.7.0 documentation</title>
  <url>https://web3py.readthedocs.io/en/stable/providers.html</url>
  <content>Using Ethereum requires access to an Ethereum node. If you have the means, you’re encouraged to [run your own node](https://ethereum.org/en/developers/docs/nodes-and-clients/run-a-node/). (Note that you do not need to stake ether to run a node.) If you’re unable to run your own node, you can use a [remote node](https://ethereum.org/en/developers/docs/nodes-and-clients/nodes-as-a-service/).
...
Choosing a Provider[](#choosing-a-provider "Link to this heading")
-------------------------------------------------------------------
...
### Provider via Environment Variable[](#provider-via-environment-variable "Link to this heading")
...
Auto-initialization Provider Shortcuts[](#auto-initialization-provider-shortcuts "Link to this heading")
---------------------------------------------------------------------------------------------------------

### Geth dev Proof of Authority[](#geth-dev-proof-of-authority "Link to this heading")
...
Built In Providers[](#built-in-providers "Link to this heading")
-----------------------------------------------------------------

Web3 ships with the following providers which are appropriate for connecting to local and remote JSON-RPC servers.

### HTTPProvider[](#httpprovider "Link to this heading")

_class_ web3.providers.rpc.HTTPProvider(_endpoint\_uri_, _request\_kwargs\={}_, _session\=None_, _exception\_retry\_configuration\=ExceptionRetryConfiguration()_)[](#web3.providers.rpc.HTTPProvider "Link to this definition")
...
### IPCProvider[](#ipcprovider "Link to this heading")

_class_ web3.providers.ipc.IPCProvider(_ipc\_path\=None_, _timeout\=10_)[](#web3.providers.ipc.IPCProvider "Link to this definition")
...
### AsyncHTTPProvider[](#asynchttpprovider "Link to this heading")

_class_ web3.providers.rpc.AsyncHTTPProvider(_endpoint\_uri_, _request\_kwargs\={}_, _exception\_retry\_configuration\=ExceptionRetryConfiguration()_)[](#web3.providers.rpc.AsyncHTTPProvider "Link to this definition")
...
### Persistent Connection Providers[](#persistent-connection-providers "Link to this heading")

#### Persistent Connection Base Class[](#persistent-connection-base-class "Link to this heading")
...
#### AsyncIPCProvider[](#asyncipcprovider "Link to this heading")

_class_ web3.providers.persistent.AsyncIPCProvider(_ipc\_path\=None_, _max\_connection\_retries\=5_)[](#web3.providers.persistent.AsyncIPCProvider "Link to this definition")
...
#### WebSocketProvider[](#websocketprovider "Link to this heading")
...
#### Using Persistent Connection Providers[](#using-persistent-connection-providers "Link to this heading")
...
#### AsyncWeb3 with Persistent Connection Providers[](#asyncweb3-with-persistent-connection-providers "Link to this heading")
...
> socket[](#socket "Link to this definition")
> 
...
#### Interacting with the Persistent Connection[](#interacting-with-the-persistent-connection "Link to this heading")

_class_ web3.providers.persistent.persistent\_connection.PersistentConnection[](#web3.providers.persistent.persistent_connection.PersistentConnection "Link to this definition")
...
subscriptions[](#web3.providers.persistent.persistent_connection.PersistentConnection.subscriptions "Link to this definition")
...
process\_subscriptions()[](#web3.providers.persistent.persistent_connection.PersistentConnection.process_subscriptions "Link to this definition")
...
send(_method: RPCEndpoint_, _params: Sequence\[Any\]_)[](#web3.providers.persistent.persistent_connection.PersistentConnection.send "Link to this definition")
...
recv()[](#web3.providers.persistent.persistent_connection.PersistentConnection.recv "Link to this definition")
...
make\_request(_method: RPCEndpoint_, _params: Sequence\[Any\]_)[](#web3.providers.persistent.persistent_connection.PersistentConnection.make_request "Link to this definition")
...
### LegacyWebSocketProvider[](#legacywebsocketprovider "Link to this heading")
...
_class_ web3.providers.legacy\_websocket.LegacyWebSocketProvider(_endpoint\_uri_\[, _websocket\_timeout_, _websocket\_kwargs_\])[](#web3.providers.legacy_websocket.LegacyWebSocketProvider "Link to this definition")
...
### AutoProvider[](#autoprovider "Link to this heading")

`AutoProvider` is the default used when initializing [`web3.Web3`](https://web3py.readthedocs.io/en/stable/web3.main.html#web3.Web3 "web3.Web3") without any providers. There’s rarely a reason to use it explicitly.

### EthereumTesterProvider[](#ethereumtesterprovider "Link to this heading")
...
_class_ web3.providers.eth\_tester.EthereumTesterProvider(_ethereum\_tester\=None_, _api\_endpoints\=None_)[](#web3.providers.eth_tester.EthereumTesterProvider "Link to this definition")

_class_ web3.providers.eth\_tester.AsyncEthereumTesterProvider(_ethereum\_tester\=None_, _api\_endpoints\=None_)[](#web3.providers.eth_tester.AsyncEthereumTesterProvider "Link to this definition")
...
<page>
  <title>Overview — web3.py 7.7.0 documentation</title>
  <url>https://web3py.readthedocs.io/en/stable/overview.html</url>
  <content>The purpose of this page is to give you a sense of everything web3.py can do and to serve as a quick reference guide. You’ll find a summary of each feature with links to learn more.
...
### Providers[](#providers "Link to this heading")
...
### Middleware[](#middleware "Link to this heading")
...
Accounts and Private Keys[](#accounts-and-private-keys "Link to this heading")
-------------------------------------------------------------------------------
...
A hosted node, like [Infura](https://infura.io/), will have no knowledge of your keys. In this case, you’ll need to have your private key available locally for signing transactions.
...
Base API[](#base-api "Link to this heading")
---------------------------------------------
...
### Encoding and Decoding Helpers[](#encoding-and-decoding-helpers "Link to this heading")
...
### Address Helpers[](#address-helpers "Link to this heading")
...
### Currency Conversions[](#currency-conversions "Link to this heading")
...
### Cryptographic Hashing[](#cryptographic-hashing "Link to this heading")
...
web3.eth API[](#web3-eth-api "Link to this heading")
-----------------------------------------------------
...
### Fetching Data[](#fetching-data "Link to this heading")
...
### Sending Transactions[](#sending-transactions "Link to this heading")
...
Contracts[](#contracts "Link to this heading")
-----------------------------------------------
...
Events, Logs, and Filters[](#events-logs-and-filters "Link to this heading")
-----------------------------------------------------------------------------
...
Net API[](#net-api "Link to this heading")
-------------------------------------------
...
<page>
  <title>Accounts — web3.py 7.7.0 documentation</title>
  <url>https://web3py.readthedocs.io/en/stable/web3.eth.account.html</url>
  <content>Local vs Hosted Nodes[](#local-vs-hosted-nodes "Link to this heading")
-----------------------------------------------------------------------
...
Local vs Hosted Keys[](#local-vs-hosted-keys "Link to this heading")
---------------------------------------------------------------------
...
Some Common Uses for Local Private Keys[](#some-common-uses-for-local-private-keys "Link to this heading")
-----------------------------------------------------------------------------------------------------------
...
Creating a Private Key[](#creating-a-private-key "Link to this heading")
-------------------------------------------------------------------------
...
Funding a New Account[](#funding-a-new-account "Link to this heading")
-----------------------------------------------------------------------
...
Reading a Private Key from an Environment Variable[](#reading-a-private-key-from-an-environment-variable "Link to this heading")
---------------------------------------------------------------------------------------------------------------------------------
...
Sign a Message[](#sign-a-message "Link to this heading")
---------------------------------------------------------
...
Verify a Message[](#verify-a-message "Link to this heading")
-------------------------------------------------------------

With the original message text and a signature:

\>>> message \= encode\_defunct(text\="I♥SF")
\>>> w3.eth.account.recover\_message(message, signature\=signed\_message.signature)
'0x5ce9454909639D2D17A3F753ce7d93fa0b9aB12E'

Prepare message for ecrecover in Solidity[](#prepare-message-for-ecrecover-in-solidity "Link to this heading")
---------------------------------------------------------------------------------------------------------------
...
Verify a message with ecrecover in Solidity[](#verify-a-message-with-ecrecover-in-solidity "Link to this heading")
-------------------------------------------------------------------------------------------------------------------
...
Sign a Transaction[](#sign-a-transaction "Link to this heading")
-----------------------------------------------------------------
...
Sign a Contract Transaction[](#sign-a-contract-transaction "Link to this heading")
-----------------------------------------------------------------------------------
...
<page>
  <title>Transactions — web3.py 7.7.0 documentation</title>
...
Chapter 0: `w3.eth.send_transaction` with `eth-tester`[](#chapter-0-w3-eth-send-transaction-with-eth-tester "Link to this heading")
------------------------------------------------------------------------------------------------------------------------------------
...
Chapter 1: `w3.eth.send_transaction` + signer middleware[](#chapter-1-w3-eth-send-transaction-signer-middleware "Link to this heading")
----------------------------------------------------------------------------------------------------------------------------------------
...
Chapter 2: `w3.eth.send_raw_transaction`[](#chapter-2-w3-eth-send-raw-transaction "Link to this heading")
----------------------------------------------------------------------------------------------------------
...
Chapter 3: Contract transactions[](#chapter-3-contract-transactions "Link to this heading")
--------------------------------------------------------------------------------------------
...
<page>
  <title>Release Notes — web3.py 7.7.0 documentation</title>
...
web3.py v7.7.0 (2025-01-15)[](#web3-py-v7-7-0-2025-01-15 "Link to this heading")
---------------------------------------------------------------------------------
...
### Miscellaneous Changes[](#miscellaneous-changes "Link to this heading")
...
web3.py v7.6.1 (2024-12-18)[](#web3-py-v7-6-1-2024-12-18 "Link to this heading")
---------------------------------------------------------------------------------

### Bugfixes[](#id1 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#internal-changes-for-web3-py-contributors "Link to this heading")
...
### Miscellaneous Changes[](#id2 "Link to this heading")

*   [#3525](https://github.com/ethereum/web3.py/issues/3525)
    

web3.py v7.6.0 (2024-11-22)[](#web3-py-v7-6-0-2024-11-22 "Link to this heading")
---------------------------------------------------------------------------------

### Bugfixes[](#id3 "Link to this heading")
...
### Features[](#id4 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id5 "Link to this heading")

*   Pin `websockets<14` due to breaking changes ([#3529](https://github.com/ethereum/web3.py/issues/3529))
    

### Miscellaneous Changes[](#id6 "Link to this heading")

*   [#3491](https://github.com/ethereum/web3.py/issues/3491)
    

web3.py v7.5.0 (2024-11-06)[](#web3-py-v7-5-0-2024-11-06 "Link to this heading")
---------------------------------------------------------------------------------

### Improved Documentation[](#id7 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id9 "Link to this heading")
...
web3.py v7.4.0 (2024-10-16)[](#web3-py-v7-4-0-2024-10-16 "Link to this heading")
---------------------------------------------------------------------------------

### Bugfixes[](#id10 "Link to this heading")
...
### Improved Documentation[](#id11 "Link to this heading")
...
### Features[](#id12 "Link to this heading")
...
web3.py v7.3.1 (2024-10-14)[](#web3-py-v7-3-1-2024-10-14 "Link to this heading")
---------------------------------------------------------------------------------

### Bugfixes[](#id13 "Link to this heading")
...
*   Fix pip install -e “.\[dev\]” command in linux README. ([#3505](https://github.com/ethereum/web3.py/issues/3505))
    

### Internal Changes - for web3.py Contributors[](#id15 "Link to this heading")

*   Update the ENSIP-15 to the latest spec and update the test suite. ([#3501](https://github.com/ethereum/web3.py/issues/3501))
    

web3.py v7.3.0 (2024-09-25)[](#web3-py-v7-3-0-2024-09-25 "Link to this heading")
---------------------------------------------------------------------------------

### Bugfixes[](#id16 "Link to this heading")
...
*   Add back dependency extra for ‘tester’. ([#3480](https://github.com/ethereum/web3.py/issues/3480))
...
### Improved Documentation[](#id17 "Link to this heading")
...
### Features[](#id18 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id19 "Link to this heading")
...
*   Re-organize the install extras. Re-define the `test` extra to always include the `tester` extra since it’s needed for testing. ([#3495](https://github.com/ethereum/web3.py/issues/3495))
    

### Miscellaneous Changes[](#id20 "Link to this heading")

*   [#3490](https://github.com/ethereum/web3.py/issues/3490)
    

### Performance Improvements[](#id21 "Link to this heading")
...
web3.py v7.2.0 (2024-08-29)[](#web3-py-v7-2-0-2024-08-29 "Link to this heading")
---------------------------------------------------------------------------------
...
### Features[](#id23 "Link to this heading")

*   HTTPProvider and AsyncHTTPProvider’s get\_request\_headers is now available on both the class and the instance ([#3467](https://github.com/ethereum/web3.py/issues/3467))
    

web3.py v7.1.0 (2024-08-28)[](#web3-py-v7-1-0-2024-08-28 "Link to this heading")
---------------------------------------------------------------------------------

### Bugfixes[](#id24 "Link to this heading")
...
### Improved Documentation[](#id25 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id27 "Link to this heading")
...
web3.py v7.0.0 (2024-08-21)[](#web3-py-v7-0-0-2024-08-21 "Link to this heading")
---------------------------------------------------------------------------------
...
### Improved Documentation[](#id28 "Link to this heading")

*   Improve batch request documentation. ([#3448](https://github.com/ethereum/web3.py/issues/3448))
    

### Internal Changes - for web3.py Contributors[](#id29 "Link to this heading")

*   Fix Release Notes formatting ([#3454](https://github.com/ethereum/web3.py/issues/3454))
    

web3.py v7.0.0-beta.9 (2024-08-01)[](#web3-py-v7-0-0-beta-9-2024-08-01 "Link to this heading")
-----------------------------------------------------------------------------------------------

### Breaking Changes[](#id30 "Link to this heading")
...
### Improved Documentation[](#id31 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id33 "Link to this heading")
...
### Miscellaneous Changes[](#id34 "Link to this heading")

*   [#3408](https://github.com/ethereum/web3.py/issues/3408), [#3445](https://github.com/ethereum/web3.py/issues/3445)
    

web3.py v7.0.0-beta.8 (2024-07-24)[](#web3-py-v7-0-0-beta-8-2024-07-24 "Link to this heading")
-----------------------------------------------------------------------------------------------

### Breaking Changes[](#id35 "Link to this heading")
...
### Bugfixes[](#id36 "Link to this heading")
...
### Features[](#id37 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id38 "Link to this heading")
...
web3.py v7.0.0-beta.7 (2024-06-26)[](#web3-py-v7-0-0-beta-7-2024-06-26 "Link to this heading")
-----------------------------------------------------------------------------------------------

### Bugfixes[](#id39 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id42 "Link to this heading")
...
web3.py v7.0.0-beta.6 (2024-05-15)[](#web3-py-v7-0-0-beta-6-2024-05-15 "Link to this heading")
-----------------------------------------------------------------------------------------------
...
### Improved Documentation[](#id44 "Link to this heading")
...
### Features[](#id45 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id46 "Link to this heading")
...
web3.py v7.0.0-beta.5 (2024-04-26)[](#web3-py-v7-0-0-beta-5-2024-04-26 "Link to this heading")
-----------------------------------------------------------------------------------------------

### Breaking Changes[](#id47 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id49 "Link to this heading")
...
web3.py v7.0.0-beta.4 (2024-04-11)[](#web3-py-v7-0-0-beta-4-2024-04-11 "Link to this heading")
-----------------------------------------------------------------------------------------------

### Bugfixes[](#id50 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id53 "Link to this heading")
...
web3.py v7.0.0-beta.3 (2024-03-28)[](#web3-py-v7-0-0-beta-3-2024-03-28 "Link to this heading")
-----------------------------------------------------------------------------------------------

### Bugfixes[](#id54 "Link to this heading")
...
### Improved Documentation[](#id55 "Link to this heading")
...
### Features[](#id56 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id57 "Link to this heading")
...
### Miscellaneous Changes[](#id58 "Link to this heading")

*   [#3304](https://github.com/ethereum/web3.py/issues/3304)
    

### Performance Improvements[](#id59 "Link to this heading")
...
### Removals[](#id60 "Link to this heading")
...
web3.py v7.0.0-beta.2 (2024-03-11)[](#web3-py-v7-0-0-beta-2-2024-03-11 "Link to this heading")
-----------------------------------------------------------------------------------------------

### Breaking Changes[](#id61 "Link to this heading")

*   Move `middlewares` -> `middleware` ([#3276](https://github.com/ethereum/web3.py/issues/3276))
    

### Bugfixes[](#id62 "Link to this heading")
...
### Improved Documentation[](#id63 "Link to this heading")
...
### Bugfixes[](#id67 "Link to this heading")
...
### Improved Documentation[](#id68 "Link to this heading")
...
### Features[](#id69 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id70 "Link to this heading")
...
### Removals[](#id73 "Link to this heading")
...
web3.py v6.14.0 (2024-01-10)[](#web3-py-v6-14-0-2024-01-10 "Link to this heading")
-----------------------------------------------------------------------------------

### Bugfixes[](#id74 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id76 "Link to this heading")
...
web3.py v6.13.0 (2023-12-20)[](#web3-py-v6-13-0-2023-12-20 "Link to this heading")
-----------------------------------------------------------------------------------

### Features[](#id77 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id78 "Link to this heading")
...
web3.py v6.12.0 (2023-12-11)[](#web3-py-v6-12-0-2023-12-11 "Link to this heading")
-----------------------------------------------------------------------------------

### Improved Documentation[](#id79 "Link to this heading")
...
### Features[](#id80 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id81 "Link to this heading")
...
web3.py v6.11.4 (2023-11-27)[](#web3-py-v6-11-4-2023-11-27 "Link to this heading")
-----------------------------------------------------------------------------------

### Bugfixes[](#id82 "Link to this heading")
...
### Miscellaneous Changes[](#id83 "Link to this heading")

*   [#3148](https://github.com/ethereum/web3.py/issues/3148)
    

web3.py v6.11.3 (2023-11-08)[](#web3-py-v6-11-3-2023-11-08 "Link to this heading")
-----------------------------------------------------------------------------------

### Bugfixes[](#id84 "Link to this heading")
...
### Improved Documentation[](#id85 "Link to this heading")

*   Adds Discord bot template repo to Resources page ([#3143](https://github.com/ethereum/web3.py/issues/3143))
    

### Internal Changes - for web3.py Contributors[](#id86 "Link to this heading")
...
web3.py v6.11.2 (2023-10-30)[](#web3-py-v6-11-2-2023-10-30 "Link to this heading")
-----------------------------------------------------------------------------------

### Improved Documentation[](#id87 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id88 "Link to this heading")
...
web3.py v6.11.1 (2023-10-18)[](#web3-py-v6-11-1-2023-10-18 "Link to this heading")
-----------------------------------------------------------------------------------

### Improved Documentation[](#id89 "Link to this heading")
...
### Features[](#id90 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id91 "Link to this heading")
...
### Miscellaneous Changes[](#id92 "Link to this heading")

*   [#3114](https://github.com/ethereum/web3.py/issues/3114), [#3129](https://github.com/ethereum/web3.py/issues/3129)
    

web3.py v6.11.0 (2023-10-11)[](#web3-py-v6-11-0-2023-10-11 "Link to this heading")
-----------------------------------------------------------------------------------

### Breaking Changes (to Beta APIs)[](#breaking-changes-to-beta-apis "Link to this heading")
...
### Bugfixes[](#id93 "Link to this heading")
...
### Improved Documentation[](#id94 "Link to this heading")
...
### Features[](#id95 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id96 "Link to this heading")
...
web3.py v6.10.0 (2023-09-21)[](#web3-py-v6-10-0-2023-09-21 "Link to this heading")
-----------------------------------------------------------------------------------

### Breaking Changes (to Beta APIs)[](#id97 "Link to this heading")
...
### Bugfixes[](#id98 "Link to this heading")
...
*   Update LogReceipt and TxReceipt declarations. Remove LogReceipt’s payload and topic attributes. Refactor LogEntry to LogReceipt. ([#3043](https://github.com/ethereum/web3.py/issues/3043))
    
*   Fixes `AsyncEth.max_priority_fee_per_gas`. It wasn’t falling back to `eth_feeHistory` since the `MethodUnavailable` error was introduced. ([#3084](https://github.com/ethereum/web3.py/issues/3084))
    

### Improved Documentation[](#id99 "Link to this heading")
...
### Features[](#id100 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id101 "Link to this heading")
...
web3.py v6.9.0 (2023-08-23)[](#web3-py-v6-9-0-2023-08-23 "Link to this heading")
---------------------------------------------------------------------------------

### Bugfixes[](#id102 "Link to this heading")

*   Fix the type for `input` in `TxData` from `HexStr` -> `HexBytes`. ([#3074](https://github.com/ethereum/web3.py/issues/3074))
    
*   Fix an issue with `WebsocketProviderV2` when responses to a request aren’t found in the cache (`None` values). ([#3075](https://github.com/ethereum/web3.py/issues/3075))
...
*   Only release `async_lock` if it’s locked to begin with. ([#3083](https://github.com/ethereum/web3.py/issues/3083))
    

### Improved Documentation[](#id103 "Link to this heading")
...
web3.py v6.8.0 (2023-08-02)[](#web3-py-v6-8-0-2023-08-02 "Link to this heading")
---------------------------------------------------------------------------------

### Bugfixes[](#id104 "Link to this heading")

*   Fix the type for the optional param asking for “full transactions” when subscribing to `newPendingTransactions` via `eth_subscribe` to `bool`. ([#3067](https://github.com/ethereum/web3.py/issues/3067))
    

### Improved Documentation[](#id105 "Link to this heading")

*   Change docs to reflect AsyncHTTPProvider does accept ENS names now ([#3070](https://github.com/ethereum/web3.py/issues/3070))
    

### Features[](#id106 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id107 "Link to this heading")

*   Minor fixes to type hinting in the core tests setup fixtures. ([#3069](https://github.com/ethereum/web3.py/issues/3069))
    

web3.py v6.7.0 (2023-07-26)[](#web3-py-v6-7-0-2023-07-26 "Link to this heading")
---------------------------------------------------------------------------------

### Bugfixes[](#id108 "Link to this heading")
...
### Improved Documentation[](#id109 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id111 "Link to this heading")
...
web3.py v6.6.1 (2023-07-12)[](#web3-py-v6-6-1-2023-07-12 "Link to this heading")
---------------------------------------------------------------------------------

### Bugfixes[](#id112 "Link to this heading")

*   Add `ens/specs` to MANIFEST.in ([#3039](https://github.com/ethereum/web3.py/issues/3039))
    

web3.py v6.6.0 (2023-07-12)[](#web3-py-v6-6-0-2023-07-12 "Link to this heading")
---------------------------------------------------------------------------------

**Note: This release was missing the required \`\`ens/specs\`\` directory, so it was yanked from Pypi in favor of v6.6.1**

### Breaking Changes[](#id113 "Link to this heading")
...
*   Fixes `max_priority_fee_per_gas`. It wasn’t falling back to `eth_feeHistory` since the `MethodUnavailable` error was introduced. ([#3002](https://github.com/ethereum/web3.py/issues/3002))
...
### Improved Documentation[](#id115 "Link to this heading")
...
*   Adds “Hackathon Helpers” section to Resources page ([#3035](https://github.com/ethereum/web3.py/issues/3035))
    

### Features[](#id116 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id117 "Link to this heading")
...
### Miscellaneous Changes[](#id118 "Link to this heading")
...
### Removals[](#id119 "Link to this heading")
...
web3.py v6.5.0 (2023-06-15)[](#web3-py-v6-5-0-2023-06-15 "Link to this heading")
---------------------------------------------------------------------------------

### Bugfixes[](#id120 "Link to this heading")
...
### Improved Documentation[](#id121 "Link to this heading")
...
*   Added ‘unsupported by any current clients’ note to the `Eth.sign_typed_data` docs ([#2961](https://github.com/ethereum/web3.py/issues/2961))
...
### Internal Changes - for web3.py Contributors[](#id123 "Link to this heading")
...
### Miscellaneous Changes[](#id124 "Link to this heading")

*   [#2960](https://github.com/ethereum/web3.py/issues/2960), [#2965](https://github.com/ethereum/web3.py/issues/2965)
    

web3.py v6.4.0 (2023-05-15)[](#web3-py-v6-4-0-2023-05-15 "Link to this heading")
---------------------------------------------------------------------------------
...
### Deprecations[](#id126 "Link to this heading")

*   add deprecation notice for the ethPM module ([#2953](https://github.com/ethereum/web3.py/issues/2953))
    

### Improved Documentation[](#id127 "Link to this heading")

*   remove reference to the ability to specify a list of providers - you can’t anymore ([#2949](https://github.com/ethereum/web3.py/issues/2949))
    
*   add deprecation notice for the ethPM module ([#2953](https://github.com/ethereum/web3.py/issues/2953))
    

### Features[](#id128 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id129 "Link to this heading")
...
*   Set towncrier settings in pyproject.toml to match the python project template and change newfragment type “doc” to “docs” ([#2959](https://github.com/ethereum/web3.py/issues/2959))
    

v6.3.0 (2023-05-03)[](#v6-3-0-2023-05-03 "Link to this heading")
-----------------------------------------------------------------

### Features[](#id130 "Link to this heading")
...
### Bugfixes[](#id131 "Link to this heading")
...
### Improved Documentation[](#id132 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id133 "Link to this heading")
...
v6.2.0 (2023-04-12)[](#v6-2-0-2023-04-12 "Link to this heading")
-----------------------------------------------------------------

### Features[](#id134 "Link to this heading")
...
v6.1.0 (2023-04-05)[](#v6-1-0-2023-04-05 "Link to this heading")
-----------------------------------------------------------------

### Features[](#id137 "Link to this heading")
...
### Bugfixes[](#id138 "Link to this heading")
...
### Improved Documentation[](#id139 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id140 "Link to this heading")
...
### Miscellaneous changes[](#id141 "Link to this heading")

*   [#2887](https://github.com/ethereum/web3.py/issues/2887)
    

v6.0.0 (2023-03-14)[](#v6-0-0-2023-03-14 "Link to this heading")
-----------------------------------------------------------------

### Bugfixes[](#id142 "Link to this heading")

*   fix dict\_to\_namedtuple unable to handle empty dict as input ([#2867](https://github.com/ethereum/web3.py/issues/2867))
    

v6.0.0-beta.11 (2023-02-24)[](#v6-0-0-beta-11-2023-02-24 "Link to this heading")
---------------------------------------------------------------------------------

### Features[](#id143 "Link to this heading")

*   Add the `sign` method to the `AsyncEth` class ([#2833](https://github.com/ethereum/web3.py/issues/2833))
    

### Bugfixes[](#id144 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id146 "Link to this heading")
...
### Breaking changes[](#id147 "Link to this heading")
...
v6.0.0-beta.10 (2023-02-15)[](#v6-0-0-beta-10-2023-02-15 "Link to this heading")
---------------------------------------------------------------------------------

### Features[](#id148 "Link to this heading")

*   add decode\_tuples option to contract instantiation ([#2799](https://github.com/ethereum/web3.py/issues/2799))
    

### Bugfixes[](#id149 "Link to this heading")
...
### Improved Documentation[](#id150 "Link to this heading")

*   Added a v6 Migraion Guide ([#2778](https://github.com/ethereum/web3.py/issues/2778))
    
*   Rebrand the library to lowercase “web3.py” ([#2804](https://github.com/ethereum/web3.py/issues/2804))
    
*   remove references to Rinkeby or replace with Goerli ([#2815](https://github.com/ethereum/web3.py/issues/2815))
    

### Internal Changes - for web3.py Contributors[](#id151 "Link to this heading")
...
### Breaking changes[](#id152 "Link to this heading")
...
v6.0.0-beta.9 (2023-01-03)[](#v6-0-0-beta-9-2023-01-03 "Link to this heading")
-------------------------------------------------------------------------------

### Features[](#id153 "Link to this heading")
...
### Improved Documentation[](#id156 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id157 "Link to this heading")
...
### Miscellaneous changes[](#id158 "Link to this heading")

*   [#2751](https://github.com/ethereum/web3.py/issues/2751)
    

### Breaking changes[](#id159 "Link to this heading")
...
v6.0.0-beta.8 (2022-11-14)[](#v6-0-0-beta-8-2022-11-14 "Link to this heading")
-------------------------------------------------------------------------------
...
### Bugfixes[](#id161 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id162 "Link to this heading")
...
v6.0.0-beta.7 (2022-10-19)[](#v6-0-0-beta-7-2022-10-19 "Link to this heading")
-------------------------------------------------------------------------------

### Bugfixes[](#id165 "Link to this heading")
...
### Improved Documentation[](#id166 "Link to this heading")

*   Added Chainstack link to quickstart docs. ([#2677](https://github.com/ethereum/web3.py/issues/2677))
    

### Deprecations and Removals[](#id167 "Link to this heading")
...
### Internal Changes - for web3.py Contributors[](#id168 "Link to this heading")

*   Clean up remaining uses of deprecated `eth_abi` methods. ([#2668](https://github.com/ethereum/web3.py/issues/2668))
    

### Miscellaneous changes[](#id169 "Link to this heading")

*   [#2671](https://github.com/ethereum/web3.py/issues/2671), [#2682](https://github.com/ethereum/web3.py/issues/2682)
    

v6.0.0-beta.6 (2022-09-26)[](#v6-0-0-beta-6-2022-09-26 "Link to this heading")
-------------------------------------------------------------------------------

### Bugfixes[](#id170 "Link to this heading")
...
### Features[](#id171 "Link to this heading")

*   Add new predefined block identifiers `safe` and `finalized`. ([#2652](https://github.com/ethereum/web3.py/issues/2652))
    

v6.0.0-beta.5 (2022-09-19)[](#v6-0-0-beta-5-2022-09-19 "Link to this heading")
-------------------------------------------------------------------------------

### Breaking Changes[](#id172 "Link to this heading")
...
### Documentation Updates[](#documentation-updates "Link to this heading")
...
### Features[](#id174 "Link to this heading")
...
v6.0.0-beta.4 (2022-07-13)[](#v6-0-0-beta-4-2022-07-13 "Link to this heading")
-------------------------------------------------------------------------------

### Breaking Changes[](#id175 "Link to this heading")
...
### Bugfixes[](#id176 "Link to this heading")
...
*   removed Optional type hints for passphrase arguments that aren’t actually optional ([#2511](https://github.com/ethereum/web3.py/issues/2511))
...
### Documentation Updates[](#id177 "Link to this heading")
...
### Features[](#id178 "Link to this heading")
...
### Misc[](#id179 "Link to this heading")
...
v6.0.0-beta.3 (2022-06-01)[](#v6-0-0-beta-3-2022-06-01 "Link to this heading")
-------------------------------------------------------------------------------

### Breaking Changes[](#id180 "Link to this heading")

*   Removed deprecated methods from eth and geth ([#1416](https://github.com/ethereum/web3.py/issues/1416))
    

### Bugfixes[](#id181 "Link to this heading")
...
### Documentation Updates[](#id182 "Link to this heading")
...
### Features[](#id183 "Link to this heading")
...
### Misc[](#id184 "Link to this heading")
...
v6.0.0-beta.2 (2022-04-27)[](#v6-0-0-beta-2-2022-04-27 "Link to this heading")
-------------------------------------------------------------------------------

### Breaking Changes[](#id185 "Link to this heading")
...
### Documentation Updates[](#id186 "Link to this heading")
...
### Features[](#id187 "Link to this heading")

*   Add ‘get\_text’ method to look up ENS text record values ([#2286](https://github.com/ethereum/web3.py/issues/2286))
...
### Misc[](#id188 "Link to this heading")
...
v6.0.0-beta.1 (2022-02-28)[](#v6-0-0-beta-1-2022-02-28 "Link to this heading")
-------------------------------------------------------------------------------

### Breaking Changes[](#id189 "Link to this heading")
...
### Bugfixes[](#id190 "Link to this heading")
...
*   Added ‘Breaking Changes’ and ‘Deprecations’ categories to our release notes ([#2340](https://github.com/ethereum/web3.py/issues/2340))
...
### Misc[](#id192 "Link to this heading")

*   [#2353](https://github.com/ethereum/web3.py/issues/2353), [#2365](https://github.com/ethereum/web3.py/issues/2365)
    

v5.28.0 (2022-02-09)[](#v5-28-0-2022-02-09 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id193 "Link to this heading")
...
### Bugfixes[](#id194 "Link to this heading")
...
v5.27.0 (2022-01-31)[](#v5-27-0-2022-01-31 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id195 "Link to this heading")
...
### Bugfixes[](#id196 "Link to this heading")
...
### Improved Documentation[](#id197 "Link to this heading")
...
### Misc[](#id198 "Link to this heading")

*   [#2217](https://github.com/ethereum/web3.py/issues/2217)
    

v5.26.0 (2022-01-06)[](#v5-26-0-2022-01-06 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id199 "Link to this heading")
...
### Bugfixes[](#id200 "Link to this heading")

*   Fixed doctest that wasn’t running in `docs/contracts.rst` ([#2213](https://github.com/ethereum/web3.py/issues/2213))
...
### Improved Documentation[](#id201 "Link to this heading")
...
### Misc[](#id202 "Link to this heading")
...
v5.25.0 (2021-11-19)[](#v5-25-0-2021-11-19 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id203 "Link to this heading")
...
### Bugfixes[](#id204 "Link to this heading")
...
### Improved Documentation[](#id205 "Link to this heading")
...
### Misc[](#id206 "Link to this heading")
...
v5.24.0 (2021-09-27)[](#v5-24-0-2021-09-27 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id207 "Link to this heading")
...
### Misc[](#id210 "Link to this heading")

*   [#2105](https://github.com/ethereum/web3.py/issues/2105)
    

v5.23.1 (2021-08-27)[](#v5-23-1-2021-08-27 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id211 "Link to this heading")
...
### Improved Documentation[](#id212 "Link to this heading")

*   Renamed “1559 transaction” to “dynamic fee transaction” where appropriate to keep consistency among the general code base for 1559 transaction (type=2) naming ([#2118](https://github.com/ethereum/web3.py/issues/2118))
...
### Misc[](#id213 "Link to this heading")
...
v5.23.0 (2021-08-12)[](#v5-23-0-2021-08-12 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id214 "Link to this heading")
...
### Bugfixes[](#id215 "Link to this heading")
...
v5.22.0 (2021-08-02)[](#v5-22-0-2021-08-02 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id217 "Link to this heading")
...
*   eth\_signTransaction support for eip-1559 params ‘maxFeePerGas’ and ‘maxPriorityFeePerGas’ ([#2082](https://github.com/ethereum/web3.py/issues/2082))
    
*   Add support for async `w3.eth.call`. ([#2083](https://github.com/ethereum/web3.py/issues/2083))
    

### Bugfixes[](#id218 "Link to this heading")
...
### Improved Documentation[](#id219 "Link to this heading")
...
### Misc[](#id220 "Link to this heading")
...
v5.21.0 (2021-07-12)[](#v5-21-0-2021-07-12 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id221 "Link to this heading")
...
### Bugfixes[](#id222 "Link to this heading")
...
### Improved Documentation[](#id223 "Link to this heading")
...
v5.20.1 (2021-07-01)[](#v5-20-1-2021-07-01 "Link to this heading")
-------------------------------------------------------------------

### Bugfixes[](#id224 "Link to this heading")
...
### Improved Documentation[](#id225 "Link to this heading")

*   Remove reference to allowing multiple providers in docs ([#2018](https://github.com/ethereum/web3.py/issues/2018))
    
*   Update “Contract Deployment Example” docs to use `py-solc-x` as `solc` is no longer maintained. ([#2020](https://github.com/ethereum/web3.py/issues/2020))
    
*   Detail using unreleased Geth builds in CI ([#2037](https://github.com/ethereum/web3.py/issues/2037))
    
*   Clarify that a missing trie node error could occur when using `block_identifier` with `.call()` on a node that isn’t running in archive mode ([#2048](https://github.com/ethereum/web3.py/issues/2048))
    

### Misc[](#id226 "Link to this heading")
...
v5.20.0 (2021-06-09)[](#v5-20-0-2021-06-09 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id227 "Link to this heading")
...
### Misc[](#id230 "Link to this heading")
...
v5.19.0 (2021-04-28)[](#v5-19-0-2021-04-28 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id231 "Link to this heading")
...
v5.18.0 (2021-04-08)[](#v5-18-0-2021-04-08 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id234 "Link to this heading")
...
### Improved Documentation[](#id235 "Link to this heading")
...
### Misc[](#id236 "Link to this heading")
...
v5.17.0 (2021-02-24)[](#v5-17-0-2021-02-24 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id237 "Link to this heading")
...
### Improved Documentation[](#id238 "Link to this heading")

*   Fix return type of `send_transaction` in docs. ([#686](https://github.com/ethereum/web3.py/issues/686))
    

v5.16.0 (2021-02-04)[](#v5-16-0-2021-02-04 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id239 "Link to this heading")
...
v5.15.0 (2021-01-15)[](#v5-15-0-2021-01-15 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id242 "Link to this heading")
...
v5.14.0 (2021-01-05)[](#v5-14-0-2021-01-05 "Link to this heading")
-------------------------------------------------------------------

### Bugfixes[](#id246 "Link to this heading")
...
### Features[](#id247 "Link to this heading")
...
v5.13.0 (2020-10-29)[](#v5-13-0-2020-10-29 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id252 "Link to this heading")
...
### Bugfixes[](#id253 "Link to this heading")
...
### Misc[](#id254 "Link to this heading")

*   [#1757](https://github.com/ethereum/web3.py/issues/1757), [#1767](https://github.com/ethereum/web3.py/issues/1767)
    

v5.12.3 (2020-10-21)[](#v5-12-3-2020-10-21 "Link to this heading")
-------------------------------------------------------------------

### Misc[](#id255 "Link to this heading")
...
v5.12.2 (2020-10-12)[](#v5-12-2-2020-10-12 "Link to this heading")
-------------------------------------------------------------------

### Bugfixes[](#id256 "Link to this heading")
...
### Misc[](#id257 "Link to this heading")
...
v5.12.1 (2020-09-02)[](#v5-12-1-2020-09-02 "Link to this heading")
-------------------------------------------------------------------

### Misc[](#id258 "Link to this heading")
...
v5.12.0 (2020-07-16)[](#v5-12-0-2020-07-16 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id259 "Link to this heading")
...
### Improved Documentation[](#id260 "Link to this heading")
...
### Misc[](#id261 "Link to this heading")
...
v5.12.0-beta.3 (2020-07-15)[](#v5-12-0-beta-3-2020-07-15 "Link to this heading")
---------------------------------------------------------------------------------
...
v5.12.0-beta.2 (2020-07-14)[](#v5-12-0-beta-2-2020-07-14 "Link to this heading")
---------------------------------------------------------------------------------
...
### Improved Documentation[](#id264 "Link to this heading")
...
v5.12.0-beta.1 (2020-07-09)[](#v5-12-0-beta-1-2020-07-09 "Link to this heading")
---------------------------------------------------------------------------------

### Features[](#id265 "Link to this heading")
...
v5.11.1 (2020-06-17)[](#v5-11-1-2020-06-17 "Link to this heading")
-------------------------------------------------------------------
...
### Improved Documentation[](#id269 "Link to this heading")

*   Breaks up links into three categories (Intro, Guides, and API) and adds content to the index page: a lib introduction and some “Getting Started” links. ([#1671](https://github.com/ethereum/web3.py/issues/1671))
...
v5.11.0 (2020-06-03)[](#v5-11-0-2020-06-03 "Link to this heading")
-------------------------------------------------------------------

### Features[](#id270 "Link to this heading")
...
v5.10.0 (2020-05-18)[](#v5-10-0-2020-05-18 "Link to this heading")
-------------------------------------------------------------------
...
### Bugfixes[](#id274 "Link to this heading")
...
### Misc[](#id275 "Link to this heading")

*   [#1636](https://github.com/ethereum/web3.py/issues/1636)
    

v5.9.0 (2020-04-30)[](#v5-9-0-2020-04-30 "Link to this heading")
-----------------------------------------------------------------

### Features[](#id276 "Link to this heading")
...
### Bugfixes[](#id277 "Link to this heading")
...
v5.8.0 (2020-04-23)[](#v5-8-0-2020-04-23 "Link to this heading")
-----------------------------------------------------------------

### Features[](#id278 "Link to this heading")
...
### Improved Documentation[](#id280 "Link to this heading")

*   Fix typo in “Internals” docs. Changed asyncronous –> asynchronous ([#1607](https://github.com/ethereum/web3.py/issues/1607))
...
### Misc[](#id281 "Link to this heading")

*   [#1545](https://github.com/ethereum/web3.py/issues/1545)
    

v5.7.0 (2020-03-16)[](#v5-7-0-2020-03-16 "Link to this heading")
-----------------------------------------------------------------

### Features[](#id282 "Link to this heading")
...
### Bugfixes[](#id286 "Link to this heading")

*   Increase replacement tx minimum gas price bump
    
    Parity/OpenEthereum requires a replacement transaction’s gas to be a minimum of 12.5% higher than the original (vs. Geth’s 10%). ([#1570](https://github.com/ethereum/web3.py/issues/1570))
    

v5.5.1 (2020-02-10)[](#v5-5-1-2020-02-10 "Link to this heading")
-----------------------------------------------------------------

### Improved Documentation[](#id287 "Link to this heading")

*   Documents the getUncleCount method. ([#1534](https://github.com/ethereum/web3.py/issues/1534))
    

### Misc[](#id288 "Link to this heading")

*   [#1576](https://github.com/ethereum/web3.py/issues/1576)
    

v5.5.0 (2020-02-03)[](#v5-5-0-2020-02-03 "Link to this heading")
-----------------------------------------------------------------

### Features[](#id289 "Link to this heading")
...
### Bugfixes[](#id290 "Link to this heading")
...
*   Make ‘from’ and ‘to’ fields checksum addresses in returned transaction receipts ([#1562](https://github.com/ethereum/web3.py/issues/1562))
    
*   Use local Trinity’s IPC socket if it is available, for newer versions of Trinity. ([#1563](https://github.com/ethereum/web3.py/issues/1563))
    

### Improved Documentation[](#id291 "Link to this heading")
...
### Misc[](#id292 "Link to this heading")
...
v5.4.0 (2019-12-06)[](#v5-4-0-2019-12-06 "Link to this heading")
-----------------------------------------------------------------

### Features[](#id293 "Link to this heading")

*   Add \_\_str\_\_ to IPCProvider ([#1536](https://github.com/ethereum/web3.py/issues/1536))
    

### Bugfixes[](#id294 "Link to this heading")

*   Add required typing-extensions library to setup.py ([#1544](https://github.com/ethereum/web3.py/issues/1544))
    

v5.3.1 (2019-12-05)[](#v5-3-1-2019-12-05 "Link to this heading")
-----------------------------------------------------------------

### Bugfixes[](#id295 "Link to this heading")
...
### Improved Documentation[](#id296 "Link to this heading")
...
### Improved Documentation[](#id300 "Link to this heading")
...
### Misc[](#id301 "Link to this heading")
...
### Misc[](#id306 "Link to this heading")

*   [#1468](https://github.com/ethereum/web3.py/issues/1468)
    

v5.2.0 (2019-09-26)[](#v5-2-0-2019-09-26 "Link to this heading")
-----------------------------------------------------------------

### Features[](#id307 "Link to this heading")
...
v5.0.1[](#v5-0-1 "Link to this heading")
-----------------------------------------
...
v5.0.0[](#v5-0-0 "Link to this heading")
-----------------------------------------
...
v5.0.0-beta.5[](#v5-0-0-beta-5 "Link to this heading")
-------------------------------------------------------
...
v5.0.0-beta.4[](#v5-0-0-beta-4 "Link to this heading")
-------------------------------------------------------
...
v5.0.0-beta.3[](#v5-0-0-beta-3 "Link to this heading")
-------------------------------------------------------
...
*   Misc
    ...
    *   Replace ethPM’s infura strategy with web3’s native infura support - [#1383](https://github.com/ethereum/web3.py/pull/1383)
...
v5.0.0-beta.2[](#v5-0-0-beta-2 "Link to this heading")
-------------------------------------------------------
...
v5.0.0-beta.1[](#v5-0-0-beta-1 "Link to this heading")
-------------------------------------------------------
...
v5.0.0-alpha.11[](#v5-0-0-alpha-11 "Link to this heading")
-----------------------------------------------------------
...
v5.0.0-alpha.10[](#v5-0-0-alpha-10 "Link to this heading")
-----------------------------------------------------------
...
v5.0.0-alpha.9[](#v5-0-0-alpha-9 "Link to this heading")
---------------------------------------------------------
...
v5.0.0-alpha.8[](#v5-0-0-alpha-8 "Link to this heading")
---------------------------------------------------------
...
v5.0.0-alpha.7[](#v5-0-0-alpha-7 "Link to this heading")
---------------------------------------------------------
...
v5.0.0-alpha.6[](#v5-0-0-alpha-6 "Link to this heading")
---------------------------------------------------------
...
v5.0.0-alpha.5[](#v5-0-0-alpha-5 "Link to this heading")
---------------------------------------------------------
...
v5.0.0-alpha.4[](#v5-0-0-alpha-4 "Link to this heading")
---------------------------------------------------------
...
v5.0.0-alpha.3[](#v5-0-0-alpha-3 "Link to this heading")
---------------------------------------------------------
...
v5.0.0-alpha.2[](#v5-0-0-alpha-2 "Link to this heading")
---------------------------------------------------------
...
v5.0.0-alpha.1[](#v5-0-0-alpha-1 "Link to this heading")
---------------------------------------------------------
...
v4.8.2[](#v4-8-2 "Link to this heading")
-----------------------------------------
...
v4.8.1[](#v4-8-1 "Link to this heading")
-----------------------------------------
...
v4.7.2[](#v4-7-2 "Link to this heading")
-----------------------------------------
...
v4.7.1[](#v4-7-1 "Link to this heading")
-----------------------------------------
...
v4.7.0[](#v4-7-0 "Link to this heading")
-----------------------------------------
...
v4.6.0[](#v4-6-0 "Link to this heading")
-----------------------------------------
...
v4.5.0[](#v4-5-0 "Link to this heading")
-----------------------------------------
...
v4.4.1[](#v4-4-1 "Link to this heading")
-----------------------------------------
...
v4.4.0[](#v4-4-0 "Link to this heading")
-----------------------------------------
...
v4.3.0[](#v4-3-0 "Link to this heading")
-----------------------------------------
...
v4.2.1[](#v4-2-1 "Link to this heading")
-----------------------------------------
...
v4.2.0[](#v4-2-0 "Link to this heading")
-----------------------------------------
...
v4.1.0[](#v4-1-0 "Link to this heading")
-----------------------------------------
...
v4.0.0[](#v4-0-0 "Link to this heading")
-----------------------------------------
...
v4.0.0-beta.13[](#v4-0-0-beta-13 "Link to this heading")
---------------------------------------------------------
...
v4.0.0-beta.12[](#v4-0-0-beta-12 "Link to this heading")
---------------------------------------------------------

A little hiccup on release. Skipped.

v4.0.0-beta.11[](#v4-0-0-beta-11 "Link to this heading")
---------------------------------------------------------
...
*   A compatibility option for connecting to `geth --dev` – see [Proof of Authority](https://web3py.readthedocs.io/en/stable/middleware.html#geth-poa)
...
v4.0.0-beta.10[](#v4-0-0-beta-10 "Link to this heading")
---------------------------------------------------------
...
v4.0.0-beta.9[](#v4-0-0-beta-9 "Link to this heading")
-------------------------------------------------------
...
v4.0.0-beta.8[](#v4-0-0-beta-8 "Link to this heading")
-------------------------------------------------------
...
v4.0.0-beta.7[](#v4-0-0-beta-7 "Link to this heading")
-------------------------------------------------------
...
v4.0.0-beta.6[](#v4-0-0-beta-6 "Link to this heading")
-------------------------------------------------------
...
*   A new, sophisticated gas estimation algorithm, based on the [https://ethgasstation.info](https://ethgasstation.info/) approach. You must opt-in to the new approach, because it’s quite slow. We recommend using the new caching middleware. See [`web3.gas_strategies.time_based.construct_time_based_gas_price_strategy()`](https://web3py.readthedocs.io/en/stable/gas_price.html#web3.gas_strategies.time_based.construct_time_based_gas_price_strategy "web3.gas_strategies.time_based.construct_time_based_gas_price_strategy")
...
v4.0.0-beta.5[](#v4-0-0-beta-5 "Link to this heading")
-------------------------------------------------------
...
v4.0.0-beta.4[](#v4-0-0-beta-4 "Link to this heading")
-------------------------------------------------------
...
*   Crashfix: [`web3.eth.Eth.filter()`](https://web3py.readthedocs.io/en/stable/web3.eth.html#web3.eth.Eth.filter "web3.eth.Eth.filter") when retrieving logs with the argument ‘latest’
...
v4.0.0-beta.3[](#v4-0-0-beta-3 "Link to this heading")
-------------------------------------------------------
...
v4.0.0-beta.2[](#v4-0-0-beta-2 "Link to this heading")
-------------------------------------------------------
...
v4.0.0-beta.1[](#v4-0-0-beta-1 "Link to this heading")
-------------------------------------------------------
...
3.16.1[](#id472 "Link to this heading")
----------------------------------------

*   Addition of `ethereum-tester` as a dependency
    

3.16.0[](#id473 "Link to this heading")
----------------------------------------
...
3.15.0[](#id474 "Link to this heading")
----------------------------------------
...
3.14.2[](#id475 "Link to this heading")
----------------------------------------

*   Fix PyPi readme text.
    

3.14.1[](#id476 "Link to this heading")
----------------------------------------

*   Fix PyPi readme text.
    

3.14.0[](#id477 "Link to this heading")
----------------------------------------
...
3.13.5[](#id478 "Link to this heading")
----------------------------------------
...
3.10.0[](#id486 "Link to this heading")
----------------------------------------
...
3.9.0[](#id487 "Link to this heading")
---------------------------------------
...
3.8.1[](#id488 "Link to this heading")
---------------------------------------
...
3.8.0[](#id489 "Link to this heading")
---------------------------------------
...
3.6.1[](#id493 "Link to this heading")
---------------------------------------

*   Upgrade `ethereum-abi-utils` dependency for upstream bugfix.
    

3.6.0[](#id494 "Link to this heading")
---------------------------------------
...
3.5.0[](#id498 "Link to this heading")
---------------------------------------
...
3.4.4[](#id499 "Link to this heading")
---------------------------------------

*   Bugfix for `web3.eth.getTransaction` when the hash is unknown.
    

3.4.3[](#id500 "Link to this heading")
---------------------------------------
...
3.4.2[](#id501 "Link to this heading")
---------------------------------------

*   Fix package so that `eth-testrpc` is not required.
    

3.4.1[](#id502 "Link to this heading")
---------------------------------------
...
3.4.0[](#id503 "Link to this heading")
---------------------------------------
...
3.3.0[](#id504 "Link to this heading")
---------------------------------------
...
3.2.0[](#id505 "Link to this heading")
---------------------------------------
...
2.8.1[](#id512 "Link to this heading")
---------------------------------------

*   Bugfix for `geth.ipc` path on linux systems.
    

2.8.0[](#id513 "Link to this heading")
---------------------------------------
...
2.7.1[](#id514 "Link to this heading")
---------------------------------------

*   Bugfix: Fix KeyError in merge\_args\_and\_kwargs helper fn.
    

2.7.0[](#id515 "Link to this heading")
---------------------------------------
...
2.6.0[](#id516 "Link to this heading")
---------------------------------------
...
2.5.0[](#id517 "Link to this heading")
---------------------------------------
...
2.4.0[](#id518 "Link to this heading")
---------------------------------------

*   Contract functions can now be called using keyword arguments.
    

2.3.0[](#id519 "Link to this heading")
---------------------------------------
...
2.2.0[](#id520 "Link to this heading")
---------------------------------------
...
2.1.1[](#id521 "Link to this heading")
---------------------------------------

*   Cast RPCProvider port to an integer.
    

2.1.0[](#id522 "Link to this heading")
---------------------------------------

*   Remove all monkeypatching
    

2.0.0[](#id523 "Link to this heading")
---------------------------------------
...
1.9.0[](#id524 "Link to this heading")
---------------------------------------

*   BugFix: fix for python3 only `json.JSONDecodeError` handling.
    

1.8.0[](#id525 "Link to this heading")
---------------------------------------
...
1.7.1[](#id526 "Link to this heading")
---------------------------------------

*   `TestRPCProvider` can now be imported directly from `web3`
    

1.7.0[](#id527 "Link to this heading")
---------------------------------------
...
1.6.0[](#id528 "Link to this heading")
---------------------------------------
...
1.5.0[](#id529 "Link to this heading")
---------------------------------------
...
1.1.0[](#id533 "Link to this heading")
---------------------------------------
...
1.0.1[](#id534 "Link to this heading")
---------------------------------------

*   Specify missing `pyrlp` and `gevent` dependencies
    

1.0.0[](#id535 "Link to this heading")
---------------------------------------

*   Massive refactor to the majority of the app.
    

0.1.0[](#id536 "Link to this heading")
---------------------------------------
...
<page>
  <title>Events and Logs — web3.py 7.7.0 documentation</title>
  <url>https://web3py.readthedocs.io/en/stable/filters.html</url>
  <content>If you’re on this page, you’re likely looking for an answer to this question: **How do I know when a specific contract is used?** You have several options:
...
Filter Class[](#filter-class "Link to this heading")
-----------------------------------------------------

_class_ web3.utils.filters.Filter(_web3_, _filter\_id_)[](#web3.utils.filters.Filter "Link to this definition")

Filter.filter\_id[](#web3.utils.filters.Filter.filter_id "Link to this definition")

The `filter_id` for this filter as returned by the `eth_newFilter` RPC method when this filter was created.

Filter.get\_new\_entries()[](#web3.utils.filters.Filter.get_new_entries "Link to this definition")
...
Filter.get\_all\_entries()[](#web3.utils.filters.Filter.get_all_entries "Link to this definition")
...
Filter.format\_entry(_entry_)[](#web3.utils.filters.Filter.format_entry "Link to this definition")
...
Filter.is\_valid\_entry(_entry_)[](#web3.utils.filters.Filter.is_valid_entry "Link to this definition")

Hook for subclasses to add additional programmatic filtering. The default implementation always returns `True`.

Block and Transaction Filter Classes[](#block-and-transaction-filter-classes "Link to this heading")
-----------------------------------------------------------------------------------------------------

_class_ web3.utils.filters.BlockFilter(_..._)[](#web3.utils.filters.BlockFilter "Link to this definition")
...
_class_ web3.utils.filters.TransactionFilter(_..._)[](#web3.utils.filters.TransactionFilter "Link to this definition")
...
Event Log Filters[](#event-log-filters "Link to this heading")
---------------------------------------------------------------
...
_class_ web3.utils.filters.LogFilter(_web3_, _filter\_id_, _log\_entry\_formatter\=None_, _data\_filter\_set\=None_)[](#web3.utils.filters.LogFilter "Link to this definition")
...
LogFilter.set\_data\_filters(_data\_filter\_set_)[](#web3.utils.filters.LogFilter.set_data_filters "Link to this definition")
...
Examples: Listening For Events[](#examples-listening-for-events "Link to this heading")
----------------------------------------------------------------------------------------

### Synchronous[](#synchronous "Link to this heading")
...
### Asynchronous Filter Polling[](#asynchronous-filter-polling "Link to this heading")
...
#### Single threaded concurrency with `async` and `await`[](#single-threaded-concurrency-with-async-and-await "Link to this heading")
...
#### Running the event loop in a separate thread[](#running-the-event-loop-in-a-separate-thread "Link to this heading")
...
### Advanced example: Fetching all token transfer events[](#advanced-example-fetching-all-token-transfer-events "Link to this heading")
...
#### eth\_getLogs limitations[](#eth-getlogs-limitations "Link to this heading")
...
<page>
  <title>Contracts — web3.py 7.7.0 documentation</title>
...
Interacting with deployed contracts[](#interacting-with-deployed-contracts "Link to this heading")
---------------------------------------------------------------------------------------------------
...
Contract Deployment Example[](#contract-deployment-example "Link to this heading")
-----------------------------------------------------------------------------------
...
Contract Factories[](#contract-factories "Link to this heading")
-----------------------------------------------------------------
...
_class_ web3.contract.Contract(_address_)[](#web3.contract.Contract "Link to this definition")
...
Contract.address[](#web3.contract.Contract.address "Link to this definition")
...
Contract.abi[](#web3.contract.Contract.abi "Link to this definition")
...
Contract.bytecode[](#web3.contract.Contract.bytecode "Link to this definition")

The contract bytecode string. May be `None` if not provided during factory creation.

Contract.bytecode\_runtime[](#web3.contract.Contract.bytecode_runtime "Link to this definition")

The runtime part of the contract bytecode string. May be `None` if not provided during factory creation.

Contract.decode\_tuples[](#web3.contract.Contract.decode_tuples "Link to this definition")
...
NamedTuples have some restrictions regarding field names. web3.py sets `NamedTuple`’s `rename=True`, so disallowed field names may be different than expected. See the [Python docs](https://docs.python.org/3/library/collections.html#collections.namedtuple) for more information.

Defaults to `False` if not provided during factory creation.

Contract.functions[](#web3.contract.Contract.functions "Link to this definition")
...
Contract.events[](#web3.contract.Contract.events "Link to this definition")
...
_classmethod_ Contract.constructor(_\*args_, _\*\*kwargs).transact(transaction=None_)[](#web3.contract.Contract.constructor "Link to this definition")
...
_classmethod_ Contract.events.your\_event\_name.create\_filter(_from\_block\=None_, _to\_block\='latest'_, _argument\_filters\={}_, _topics\=\[\]_)[](#web3.contract.Contract.events.your_event_name.create_filter "Link to this definition")
...
_classmethod_ Contract.events.your\_event\_name.build\_filter()[](#web3.contract.Contract.events.your_event_name.build_filter "Link to this definition")
...
_classmethod_ Contract.encode\_abi(_abi\_element\_identifier_, _args\=None_, _kwargs\=None_, _data\=None_)[](#web3.contract.Contract.encode_abi "Link to this definition")
...
_classmethod_ Contract.all\_events()[](#web3.contract.Contract.all_events "Link to this definition")
...
_classmethod_ Contract.get\_event\_by\_signature(_signature_)[](#web3.contract.Contract.get_event_by_signature "Link to this definition")
...
_classmethod_ Contract.find\_events\_by\_name(_name_)[](#web3.contract.Contract.find_events_by_name "Link to this definition")
...
_classmethod_ Contract.get\_event\_by\_name(_name_)[](#web3.contract.Contract.get_event_by_name "Link to this definition")
...
_classmethod_ Contract.find\_events\_by\_selector(_selector_)[](#web3.contract.Contract.find_events_by_selector "Link to this definition")
...
_classmethod_ Contract.get\_event\_by\_selector(_selector_)[](#web3.contract.Contract.get_event_by_selector "Link to this definition")
...
_classmethod_ Contract.find\_events\_by\_topic(_topic_)[](#web3.contract.Contract.find_events_by_topic "Link to this definition")
...
_classmethod_ Contract.get\_event\_by\_topic(_topic_)[](#web3.contract.Contract.get_event_by_topic "Link to this definition")
...
_classmethod_ Contract.all\_functions()[](#web3.contract.Contract.all_functions "Link to this definition")
...
_classmethod_ Contract.get\_function\_by\_signature(_signature_)[](#web3.contract.Contract.get_function_by_signature "Link to this definition")
...
_classmethod_ Contract.find\_functions\_by\_name(_name_)[](#web3.contract.Contract.find_functions_by_name "Link to this definition")
...
_classmethod_ Contract.get\_function\_by\_name(_name_)[](#web3.contract.Contract.get_function_by_name "Link to this definition")
...
_classmethod_ Contract.get\_function\_by\_selector(_selector_)[](#web3.contract.Contract.get_function_by_selector "Link to this definition")
...
_classmethod_ Contract.find\_functions\_by\_args(_\*args_)[](#web3.contract.Contract.find_functions_by_args "Link to this definition")
...
_classmethod_ Contract.get\_function\_by\_args(_\*args_)[](#web3.contract.Contract.get_function_by_args "Link to this definition")
...
Disabling Strict Checks for Bytes Types[](#disabling-strict-checks-for-bytes-types "Link to this heading")
-----------------------------------------------------------------------------------------------------------
...
[](#id9 "Link to this table")Invalid byte and hex strings with strict (default) bytes4 type checking
...
[](#id10 "Link to this table")Valid byte and hex strings for a non-strict bytes4 type
...
Contract Functions[](#contract-functions "Link to this heading")
-----------------------------------------------------------------
...
_class_ web3.contract.ContractFunction[](#web3.contract.ContractFunction "Link to this definition")
...
### Methods[](#id3 "Link to this heading")
...
ContractFunction.transact(_transaction_)[](#web3.contract.ContractFunction.transact "Link to this definition")
...
ContractFunction.call(_transaction_, _block\_identifier\='latest'_)[](#web3.contract.ContractFunction.call "Link to this definition")
...
ContractFunction.estimate\_gas(_transaction_, _block\_identifier\=None_)[](#web3.contract.ContractFunction.estimate_gas "Link to this definition")
...
ContractFunction.build\_transaction(_transaction_)[](#web3.contract.ContractFunction.build_transaction "Link to this definition")
...
Contract.fallback.call(_transaction_)[](#web3.contract.Contract.fallback.call "Link to this definition")
...
Contract.fallback.estimate\_gas(_transaction_)[](#web3.contract.Contract.fallback.estimate_gas "Link to this definition")

Call fallback function and return the gas estimation.

Contract.fallback.transact(_transaction_)[](#web3.contract.Contract.fallback.transact "Link to this definition")

Execute fallback function by sending a new public transaction.

Contract.fallback.build\_transaction(_transaction_)[](#web3.contract.Contract.fallback.build_transaction "Link to this definition")

Builds a transaction dictionary based on the contract fallback function call.

Contract Events[](#contract-events "Link to this heading")
-----------------------------------------------------------
...
_class_ web3.contract.ContractEvent[](#web3.contract.ContractEvent "Link to this definition")

### Attributes[](#id5 "Link to this heading")
...
ContractEvent.process\_log(_log_)[](#web3.contract.ContractEvent.process_log "Link to this definition")
...
### Event Log Object[](#event-log-object "Link to this heading")
...
_classmethod_ Contract.decode\_function\_input(_data_)[](#web3.contract.Contract.decode_function_input "Link to this definition")
...
ContractCaller[](#contractcaller "Link to this heading")
---------------------------------------------------------

_class_ web3.contract.ContractCaller[](#web3.contract.ContractCaller "Link to this definition")
...
### Working with an ERC-20 Token Contract[](#working-with-an-erc-20-token-contract "Link to this heading")
...
#### Creating the contract factory[](#creating-the-contract-factory "Link to this heading")
...
#### Querying token metadata[](#querying-token-metadata "Link to this heading")
...
#### Query account balances[](#query-account-balances "Link to this heading")
...
#### Sending tokens[](#sending-tokens "Link to this heading")
...
#### Creating an approval for external transfers[](#creating-an-approval-for-external-transfers "Link to this heading")

Alice could also _approve_ someone else to spend tokens from her account using the `approve` function. We can also query how many tokens we’re approved to spend using the `allowance` function.
...
#### Performing an external transfer[](#performing-an-external-transfer "Link to this heading")
...
### Using a struct as a function argument[](#using-a-struct-as-a-function-argument "Link to this heading")
...
### Invoke Ambiguous Contract Functions[](#invoke-ambiguous-contract-functions "Link to this heading")
...
### CCIP Read support for offchain lookup[](#ccip-read-support-for-offchain-lookup "Link to this heading")
...
### Contract Unit Tests in Python[](#contract-unit-tests-in-python "Link to this heading")
...
<page>
  <title>Middleware — web3.py 7.7.0 documentation</title>
...
Configuring Middleware[](#configuring-middleware "Link to this heading")
-------------------------------------------------------------------------
...
### Middleware Order[](#middleware-order "Link to this heading")
...
### Middleware Stack API[](#middleware-stack-api "Link to this heading")

To add or remove items in different layers, use the following API:

Web3.middleware\_onion.add(_middleware_, _name\=None_)[](#Web3.middleware_onion.add "Link to this definition")
...
Web3.middleware\_onion.inject(_middleware_, _name\=None_, _layer\=None_)[](#Web3.middleware_onion.inject "Link to this definition")
...
Web3.middleware\_onion.remove(_middleware_)[](#Web3.middleware_onion.remove "Link to this definition")
...
Web3.middleware\_onion.replace(_old\_middleware_, _new\_middleware_)[](#Web3.middleware_onion.replace "Link to this definition")
...
Web3.middleware\_onion.clear()[](#Web3.middleware_onion.clear "Link to this definition")
...
Web3.middleware\_onion.middleware[](#Web3.middleware_onion.middleware "Link to this definition")
...
### Instantiate with Custom Middleware[](#instantiate-with-custom-middleware "Link to this heading")
...
Default Middleware[](#default-middleware "Link to this heading")
-----------------------------------------------------------------
...
### AttributeDict[](#attributedict "Link to this heading")

_class_ web3.middleware.AttributeDictMiddleware[](#web3.middleware.AttributeDictMiddleware "Link to this definition")
...
### ENS Name to Address Resolution[](#ens-name-to-address-resolution "Link to this heading")

_class_ web3.middleware.ENSNameToAddressMiddleware[](#web3.middleware.ENSNameToAddressMiddleware "Link to this definition")

This middleware converts Ethereum Name Service (ENS) names into the address that the name points to. For example [`w3.eth.send_transaction`](https://web3py.readthedocs.io/en/stable/web3.eth.html#web3.eth.Eth.send_transaction "web3.eth.Eth.send_transaction") will accept .eth names in the ‘from’ and ‘to’ fields.
...
### Gas Price Strategy[](#gas-price-strategy "Link to this heading")

_class_ web3.middleware.GasPriceStrategyMiddleware[](#web3.middleware.GasPriceStrategyMiddleware "Link to this definition")
...
### Buffered Gas Estimate[](#buffered-gas-estimate "Link to this heading")

_class_ web3.middleware.BufferedGasEstimateMiddleware[](#web3.middleware.BufferedGasEstimateMiddleware "Link to this definition")
...
### Validation[](#validation "Link to this heading")

_class_ web3.middleware.ValidationMiddleware[](#web3.middleware.ValidationMiddleware "Link to this definition")

This middleware includes block and transaction validators which perform validations for transaction parameters.

Optional Middleware[](#optional-middleware "Link to this heading")
-------------------------------------------------------------------
...
### Stalecheck[](#stalecheck "Link to this heading")

web3.middleware.StalecheckMiddlewareBuilder()[](#web3.middleware.StalecheckMiddlewareBuilder "Link to this definition")
...
### Proof of Authority[](#proof-of-authority "Link to this heading")
...
### Locally Managed Log and Block Filters[](#locally-managed-log-and-block-filters "Link to this heading")

web3.middleware.LocalFilterMiddleware()[](#web3.middleware.LocalFilterMiddleware "Link to this definition")
...
### Signing[](#signing "Link to this heading")

web3.middleware.SignAndSendRawMiddlewareBuilder()[](#web3.middleware.SignAndSendRawMiddlewareBuilder "Link to this definition")
...
Creating Custom Middleware[](#creating-custom-middleware "Link to this heading")
---------------------------------------------------------------------------------
...
<page>
  <title>Web3 Internals — web3.py 7.7.0 documentation</title>
...
Request Lifecycle[](#request-lifecycle "Link to this heading")
---------------------------------------------------------------
...
### Writing your own Provider[](#writing-your-own-provider "Link to this heading")
...
BaseProvider.make\_request(_method_, _params_)[](#BaseProvider.make_request "Link to this definition")
...
BaseProvider.is\_connected(_show\_traceback\=False_)[](#BaseProvider.is_connected "Link to this definition")
...
BaseProvider.middleware[](#BaseProvider.middleware "Link to this definition")
...
### Provider Configurations[](#provider-configurations "Link to this heading")

#### Request Caching[](#request-caching "Link to this heading")
...
#### Retry Requests for HTTP Providers[](#retry-requests-for-http-providers "Link to this heading")
...
_class_ web3.providers.rpc.utils.ExceptionRetryConfiguration[](#web3.providers.rpc.utils.ExceptionRetryConfiguration "Link to this definition")

errors[](#web3.providers.rpc.utils.ExceptionRetryConfiguration.errors "Link to this definition")
...
retries[](#web3.providers.rpc.utils.ExceptionRetryConfiguration.retries "Link to this definition")

The number of retries to attempt. The default is 5.

backoff\_factor[](#web3.providers.rpc.utils.ExceptionRetryConfiguration.backoff_factor "Link to this definition")

The initial delay multiplier, which doubles with each retry attempt. The default is 0.125.

method\_allowlist[](#web3.providers.rpc.utils.ExceptionRetryConfiguration.method_allowlist "Link to this definition")
...
Request Processing for Persistent Connection Providers[](#request-processing-for-persistent-connection-providers "Link to this heading")
-----------------------------------------------------------------------------------------------------------------------------------------

_class_ web3.providers.persistent.request\_processor.RequestProcessor[](#web3.providers.persistent.request_processor.RequestProcessor "Link to this definition")
...
### Listening for Responses[](#listening-for-responses "Link to this heading")
...
### One-To-One Requests[](#one-to-one-requests "Link to this heading")
...
_class_ web3.\_utils.caching.RequestInformation[](#web3._utils.caching.RequestInformation "Link to this definition")

method[](#web3._utils.caching.RequestInformation.method "Link to this definition")

The name of the method - e.g. “eth\_subscribe”.

params[](#web3._utils.caching.RequestInformation.params "Link to this definition")

The params used when the call was made - e.g. (“newPendingTransactions”, True).

response\_formatters[](#web3._utils.caching.RequestInformation.response_formatters "Link to this definition")

The formatters that will be used to process the response.

middleware\_response\_processors[](#web3._utils.caching.RequestInformation.middleware_response_processors "Link to this definition")
...
subscription\_id[](#web3._utils.caching.RequestInformation.subscription_id "Link to this definition")
...
### One-To-Many Requests[](#one-to-many-requests "Link to this heading")
...
<page>
  <title>Ethereum Name Service (ENS) — web3.py 7.7.0 documentation</title>
...
ens.strict\_bytes\_type\_checking[](#ens.strict_bytes_type_checking "Link to this definition")
...
### Name Info[](#name-info "Link to this heading")

#### Get the Address for an ENS Name[](#get-the-address-for-an-ens-name "Link to this heading")
...
##### Multichain Address Resolution[](#multichain-address-resolution "Link to this heading")
...
#### Get the ENS Name for an Address[](#get-the-ens-name-for-an-address "Link to this heading")
...
#### Get the Owner of a Name[](#get-the-owner-of-a-name "Link to this heading")

eth\_address \= ns.owner('exchange.eth')

* * *

### Set Up Your Name and Address[](#set-up-your-name-and-address "Link to this heading")

#### Link a Name to an Address[](#link-a-name-to-an-address "Link to this heading")
...
##### Multichain Address Support[](#multichain-address-support "Link to this heading")
...
#### Link an Address to a Name[](#link-an-address-to-a-name "Link to this heading")
...
### Text Records[](#text-records "Link to this heading")

#### Set Text Metadata for an ENS Record[](#set-text-metadata-for-an-ens-record "Link to this heading")

As the owner of an ENS record, you can add text metadata. A list of supported fields can be found in the [ENS documentation](https://docs.ens.domains/resolvers/public#get-text-data). You’ll need to setup the address first, and then the text can be set:
...
#### Read Text Metadata for an ENS Record[](#read-text-metadata-for-an-ens-record "Link to this heading")
...
### Working With Resolvers[](#working-with-resolvers "Link to this heading")

#### Get the Resolver for an ENS Record[](#get-the-resolver-for-an-ens-record "Link to this heading")
...
Wildcard Resolution Support[](#wildcard-resolution-support "Link to this heading")
-----------------------------------------------------------------------------------
...
<page>
  <title>Troubleshooting — web3.py 7.7.0 documentation</title>
  <url>https://web3py.readthedocs.io/en/stable/troubleshooting.html</url>
  <content>Set up a clean environment[](#set-up-a-clean-environment "Link to this heading")
---------------------------------------------------------------------------------
...
Why can’t I use a particular function?[](#why-can-t-i-use-a-particular-function "Link to this heading")
--------------------------------------------------------------------------------------------------------
...
Why isn’t my web3 instance connecting to the network?[](#why-isn-t-my-web3-instance-connecting-to-the-network "Link to this heading")
--------------------------------------------------------------------------------------------------------------------------------------
...
If that does not address your issue, it’s probable that you still have a Provider configuration issue. There are several options for configuring a Provider, detailed [here](https://web3py.readthedocs.io/en/stable/providers.html#providers).

How do I get ether for my test network?[](#how-do-i-get-ether-for-my-test-network "Link to this heading")
----------------------------------------------------------------------------------------------------------
...
How do I use my MetaMask accounts from web3.py?[](#how-do-i-use-my-metamask-accounts-from-web3-py "Link to this heading")
--------------------------------------------------------------------------------------------------------------------------
...
How do I create an account?[](#how-do-i-create-an-account "Link to this heading")
----------------------------------------------------------------------------------
...
Why doesn’t my transaction work on another network?[](#why-doesn-t-my-transaction-work-on-another-network "Link to this heading")
----------------------------------------------------------------------------------------------------------------------------------

web3.py is an Ethereum-specific library, which defaults to [“type 2” EIP-1559 transactions](https://ethereum.org/en/developers/docs/transactions/#typed-transaction-envelope) as of the London network upgrade. Some chains (including Ethereum L2s) do not support the same transaction types.
...
### Hexadecimal Representations[](#hexadecimal-representations "Link to this heading")
...
### Ethereum Addresses[](#ethereum-addresses "Link to this heading")
...
### Disabling Strict Bytes Type Checking[](#disabling-strict-bytes-type-checking "Link to this heading")

There is a boolean flag on the `Web3` class and the `ENS` class that will disable strict bytes type checking. This allows bytes values of Python strings and allows byte strings less than the specified byte size, appropriately padding values that need padding. To disable stricter checks, set the `w3.strict_bytes_type_checking` (or `ns.strict_bytes_type_checking`) flag to `False`. This will no longer cause the `Web3` / `ENS` instance to raise an error if a Python string is passed in without a “0x” prefix. It will also render valid byte strings or hex strings that are below the exact number of bytes specified by the ABI type by padding the value appropriately, according to the ABI type. See the [Disabling Strict Checks for Bytes Types](https://web3py.readthedocs.io/en/stable/web3.contract.html#disable-strict-byte-check) section for an example on using the flag and more details.
...
### Types by Example[](#types-by-example "Link to this heading")
...
#### Unsigned Integers[](#unsigned-integers "Link to this heading")
...
#### Signed Integers[](#signed-integers "Link to this heading")
...
How can I optimize Ethereum JSON-RPC API access?[](#how-can-i-optimize-ethereum-json-rpc-api-access "Link to this heading")
----------------------------------------------------------------------------------------------------------------------------
...
Why am I getting Visual C++ or Cython not installed error?[](#why-am-i-getting-visual-c-or-cython-not-installed-error "Link to this heading")
----------------------------------------------------------------------------------------------------------------------------------------------
...
How do I convert currency denominations?[](#how-do-i-convert-currency-denominations "Link to this heading")
------------------------------------------------------------------------------------------------------------
...
To convert back to wei, you can use the inverse function, `to_wei()`. Note that Python’s default floating point precision is insufficient for this use case, so it’s necessary to cast the value to a [Decimal](https://docs.python.org/3/library/decimal.html) if it isn’t already.
...
How do I adjust the log levels?[](#how-do-i-adjust-the-log-levels "Link to this heading")
------------------------------------------------------------------------------------------
...
<page>
  <title>Migration Guide — web3.py 7.7.0 documentation</title>
  <url>https://web3py.readthedocs.io/en/stable/migration.html</url>
  <content>Migrating from v6 to v7[](#migrating-from-v6-to-v7 "Link to this heading")
---------------------------------------------------------------------------
...
### Provider Updates[](#provider-updates "Link to this heading")
...
#### AsyncIPCProvider (non-breaking feature)[](#asyncipcprovider-non-breaking-feature "Link to this heading")
...
### Middlewares -> Middleware[](#middlewares-middleware "Link to this heading")
...
### Class-Based Middleware Model[](#class-based-middleware-model "Link to this heading")
...
### Middleware Builder Classes[](#middleware-builder-classes "Link to this heading")
...
### Middleware Renaming and Removals[](#middleware-renaming-and-removals "Link to this heading")
...
#### ABI Middleware[](#abi-middleware "Link to this heading")
...
#### Caching Middleware[](#caching-middleware "Link to this heading")
...
#### Result Generating Middleware[](#result-generating-middleware "Link to this heading")
...
#### HTTP Retry Request Middleware[](#http-retry-request-middleware "Link to this heading")
...
#### Normalize Request Parameters Middleware[](#normalize-request-parameters-middleware "Link to this heading")

The `normalize_request_parameters` middleware was not used anywhere internally and has been removed.

### Remaining camelCase -> snake\_case Updates[](#remaining-camelcase-snake-case-updates "Link to this heading")
...
### Changes to Exception Handling[](#changes-to-exception-handling "Link to this heading")
...
#### JSON-RPC Error Handling[](#json-rpc-error-handling "Link to this heading")
...
### End of Support and Feature Removals[](#end-of-support-and-feature-removals "Link to this heading")

#### Python 3.7 Support Dropped[](#python-3-7-support-dropped "Link to this heading")
...
#### EthPM Module Removed[](#ethpm-module-removed "Link to this heading")
...
#### Geth Miner Namespace Removed[](#geth-miner-namespace-removed "Link to this heading")
...
#### Geth Personal Namespace Removed[](#geth-personal-namespace-removed "Link to this heading")
...
#### ABI Types Removed[](#abi-types-removed "Link to this heading")
...
Migrating from v5 to v6[](#migrating-from-v5-to-v6 "Link to this heading")
---------------------------------------------------------------------------

web3.py follows [Semantic Versioning](http://semver.org/), which means that version 6 introduced backwards-incompatible changes. If your project depends on web3.py v6, then you’ll probably need to make some changes.

Breaking Changes:

### Strict Bytes Checking by Default[](#strict-bytes-checking-by-default "Link to this heading")
...
### Snake Case[](#snake-case "Link to this heading")
...
*   Contract methods and events use whatever is listed in the ABI. If the smart contract convention is to use camelCase for method and event names, web3.py won’t do any magic to convert it to snake\_casing.
...
### Python 3.10 and 3.11 Support[](#python-3-10-and-3-11-support "Link to this heading")
...
#### Exceptions inherit from a base class[](#exceptions-inherit-from-a-base-class "Link to this heading")
...
#### ValidationError[](#validationerror "Link to this heading")
...
### Web3 class split into Web3 and AsyncWeb3[](#web3-class-split-into-web3-and-asyncweb3 "Link to this heading")
...
### dict to AttributeDict conversion moved to middleware[](#dict-to-attributedict-conversion-moved-to-middleware "Link to this heading")
...
### Other Misc Changes[](#other-misc-changes "Link to this heading")
...
*   Logs’ data field was previously formatted with to\_ascii\_if\_bytes, now formatted to HexBytes
    
*   Receipts’ type field was previously not formatted, now formatted with to\_integer\_if\_hex
...
### Other notable changes[](#other-notable-changes "Link to this heading")
...
Migrating from v4 to v5[](#migrating-from-v4-to-v5 "Link to this heading")
---------------------------------------------------------------------------

Web3.py follows [Semantic Versioning](http://semver.org/), which means that version 5 introduced backwards-incompatible changes. If your project depends on Web3.py v4, then you’ll probably need to make some changes.

Here are the most common required updates:

### Python 3.5 no longer supported[](#python-3-5-no-longer-supported "Link to this heading")

You will need to upgrade to either Python 3.6 or 3.7

### `eth-abi` v1 no longer supported[](#eth-abi-v1-no-longer-supported "Link to this heading")

You will need to upgrade the `eth-abi` dependency to v2

### Changes to base API[](#changes-to-base-api "Link to this heading")

#### JSON-RPC Updates[](#json-rpc-updates "Link to this heading")
...
#### Removed Methods[](#removed-methods "Link to this heading")
...
#### Deprecated Methods[](#deprecated-methods "Link to this heading")
...
#### Deprecated ConciseContract and ImplicitContract[](#deprecated-concisecontract-and-implicitcontract "Link to this heading")
...
### Manager Provider[](#manager-provider "Link to this heading")
...
### Testnet Changes[](#testnet-changes "Link to this heading")
...
### Required Infura API Key[](#required-infura-api-key "Link to this heading")

In order to interact with Infura after March 27, 2019, you’ll need to set an environment variable called `WEB3_INFURA_PROJECT_ID`. You can get a project id by visiting [https://infura.io/register](https://infura.io/register).

Migrating from v3 to v4[](#migrating-from-v3-to-v4 "Link to this heading")
---------------------------------------------------------------------------

Web3.py follows [Semantic Versioning](http://semver.org/), which means that version 4 introduced backwards-incompatible changes. If your project depends on Web3.py v3, then you’ll probably need to make some changes.

Here are the most common required updates:

### Python 2 to Python 3[](#python-2-to-python-3 "Link to this heading")
...
### TestRPCProvider and EthereumTesterProvider[](#testrpcprovider-and-ethereumtesterprovider "Link to this heading")
...
### Changes to base API convenience methods[](#changes-to-base-api-convenience-methods "Link to this heading")

#### Web3.toDecimal()[](#web3-todecimal "Link to this heading")
...
#### Removed Methods[](#id5 "Link to this heading")
...
### Provider Access[](#provider-access "Link to this heading")

In v4, `w3.currentProvider` was removed, in favor of `w3.providers`.

### Disambiguating String Inputs[](#disambiguating-string-inputs "Link to this heading")
...
_class_ web3.Web3(_provider_)[](#web3.Web3 "Link to this definition")

Each `Web3` instance exposes the following APIs.

[Providers](#id2)[](#providers "Link to this heading")
-------------------------------------------------------

Web3.HTTPProvider[](#web3.Web3.HTTPProvider "Link to this definition")
...
Web3.IPCProvider[](#web3.Web3.IPCProvider "Link to this definition")
...
[Attributes](#id3)[](#attributes "Link to this heading")
---------------------------------------------------------

Web3.api[](#web3.Web3.api "Link to this definition")

Returns the current Web3 version.

Web3.client\_version[](#web3.Web3.client_version "Link to this definition")
...
[Batch Requests](#id4)[](#batch-requests "Link to this heading")
-----------------------------------------------------------------

Web3.batch\_requests()[](#web3.Web3.batch_requests "Link to this definition")
...
### Async Batch Requests[](#async-batch-requests "Link to this heading")
...
[Encoding and Decoding Helpers](#id5)[](#encoding-and-decoding-helpers "Link to this heading")
-----------------------------------------------------------------------------------------------

Web3.to\_hex(_primitive\=None_, _hexstr\=None_, _text\=None_)[](#web3.Web3.to_hex "Link to this definition")
...
\>>> Web3.to\_hex(text\='')
'0x'
\>>> Web3.to\_hex(text\='cowmö')
'0x636f776dc3b6'

Web3.to\_text(_primitive\=None_, _hexstr\=None_, _text\=None_)[](#web3.Web3.to_text "Link to this definition")
...
'cowmö'
\>>> Web3.to\_text(text\='cowmö')
'cowmö'

Web3.to\_bytes(_primitive\=None_, _hexstr\=None_, _text\=None_)[](#web3.Web3.to_bytes "Link to this definition")
...
\>>> Web3.to\_bytes(text\='')
b''
\>>> Web3.to\_bytes(text\='cowmö')
b'cowm\\xc3\\xb6'

Web3.to\_int(_primitive\=None_, _hexstr\=None_, _text\=None_)[](#web3.Web3.to_int "Link to this definition")
...
Web3.to\_json(_obj_)[](#web3.Web3.to_json "Link to this definition")
...
[Currency Conversions](#id6)[](#currency-conversions "Link to this heading")
-----------------------------------------------------------------------------

Web3.to\_wei(_value_, _currency_)[](#web3.Web3.to_wei "Link to this definition")
...
Web3.from\_wei(_value_, _currency_)[](#web3.Web3.from_wei "Link to this definition")
...
[Addresses](#id7)[](#addresses "Link to this heading")
-------------------------------------------------------

Web3.is\_address(_value_)[](#web3.Web3.is_address "Link to this definition")
...
Web3.is\_checksum\_address(_value_)[](#web3.Web3.is_checksum_address "Link to this definition")
...
Web3.to\_checksum\_address(_value_)[](#web3.Web3.to_checksum_address "Link to this definition")
...
[Cryptographic Hashing](#id8)[](#cryptographic-hashing "Link to this heading")
-------------------------------------------------------------------------------

_classmethod_ Web3.keccak(_primitive\=None_, _hexstr\=None_, _text\=None_)[](#web3.Web3.keccak "Link to this definition")
...
_classmethod_ Web3.solidity\_keccak(_abi\_types_, _value_)[](#web3.Web3.solidity_keccak "Link to this definition")
...
[Check Encodability](#id9)[](#check-encodability "Link to this heading")
-------------------------------------------------------------------------

w3.is\_encodable(_\_type_, _value_)[](#web3.w3.is_encodable "Link to this definition")
...
w3.strict\_bytes\_type\_checking[](#web3.w3.strict_bytes_type_checking "Link to this definition")
...
[RPC API Modules](#id10)[](#rpc-api-modules "Link to this heading")
--------------------------------------------------------------------

Each `Web3` instance also exposes these namespaced API modules.

Web3.eth[](#web3.Web3.eth "Link to this definition")

See [web3.eth API](https://web3py.readthedocs.io/en/stable/web3.eth.html)

Web3.geth[](#web3.Web3.geth "Link to this definition")
...
[Custom Methods](#id11)[](#custom-methods "Link to this heading")
------------------------------------------------------------------
...
[External Modules](#id12)[](#external-modules "Link to this heading")
----------------------------------------------------------------------
...
w3.attach\_modules(_modules_)[](#web3.w3.attach_modules "Link to this definition")
...
<page>
  <title>web3.eth API — web3.py 7.7.0 documentation</title>
  <url>https://web3py.readthedocs.io/en/stable/web3.eth.html</url>
  <content>_class_ web3.eth.Eth[](#web3.eth.Eth "Link to this definition")
...
Eth.max\_priority\_fee[](#web3.eth.Eth.max_priority_fee "Link to this definition")
...
Eth.gas\_price[](#web3.eth.Eth.gas_price "Link to this definition")
...
Eth.accounts[](#web3.eth.Eth.accounts "Link to this definition")
...
Eth.block\_number[](#web3.eth.Eth.block_number "Link to this definition")
...
Eth.chain\_id[](#web3.eth.Eth.chain_id "Link to this definition")

> *   Delegates to `eth_chainId` RPC Method
>     
> 
> Returns an integer value for the currently configured “Chain Id” value introduced in [EIP-155](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-155.md). Returns `None` if no Chain Id is available.
...
Eth.get\_balance(_account_, _block\_identifier\=eth.default\_block_)[](#web3.eth.Eth.get_balance "Link to this definition")
...
Eth.get\_block\_number()[](#web3.eth.Eth.get_block_number "Link to this definition")
...
Eth.get\_storage\_at(_account_, _position_, _block\_identifier\=eth.default\_block_)[](#web3.eth.Eth.get_storage_at "Link to this definition")
...
Eth.blob\_base\_fee()[](#web3.eth.Eth.blob_base_fee "Link to this definition")
...
Eth.get\_proof(_account_, _positions_, _block\_identifier\=eth.default\_block_)[](#web3.eth.Eth.get_proof "Link to this definition")
...
Eth.get\_code(_account_, _block\_identifier\=eth.default\_block_)[](#web3.eth.Eth.get_code "Link to this definition")
...
Eth.get\_block(_block\_identifier\=eth.default\_block_, _full\_transactions\=False_)[](#web3.eth.Eth.get_block "Link to this definition")
...
Eth.get\_block\_transaction\_count(_block\_identifier_)[](#web3.eth.Eth.get_block_transaction_count "Link to this definition")
...
Eth.get\_uncle\_by\_block(_block\_identifier_, _uncle\_index_)[](#web3.eth.Eth.get_uncle_by_block "Link to this definition")
...
Eth.get\_uncle\_count(_block\_identifier_)[](#web3.eth.Eth.get_uncle_count "Link to this definition")
...
Eth.get\_transaction(_transaction\_hash_)[](#web3.eth.Eth.get_transaction "Link to this definition")
...
Eth.get\_raw\_transaction(_transaction\_hash_)[](#web3.eth.Eth.get_raw_transaction "Link to this definition")
...
Eth.get\_transaction\_by\_block(_block\_identifier_, _transaction\_index_)[](#web3.eth.Eth.get_transaction_by_block "Link to this definition")
...
Eth.get\_raw\_transaction\_by\_block(_block\_identifier_, _transaction\_index_)[](#web3.eth.Eth.get_raw_transaction_by_block "Link to this definition")
...
Eth.wait\_for\_transaction\_receipt(_transaction\_hash_, _timeout\=120_, _poll\_latency\=0.1_)[](#web3.eth.Eth.wait_for_transaction_receipt "Link to this definition")
...
Eth.get\_transaction\_receipt(_transaction\_hash_)[](#web3.eth.Eth.get_transaction_receipt "Link to this definition")
...
Eth.get\_transaction\_count(_account_, _block\_identifier\=web3.eth.default\_block_)[](#web3.eth.Eth.get_transaction_count "Link to this definition")
...
Eth.send\_transaction(_transaction_)[](#web3.eth.Eth.send_transaction "Link to this definition")
...
Eth.sign\_transaction(_transaction_)[](#web3.eth.Eth.sign_transaction "Link to this definition")
...
Eth.send\_raw\_transaction(_raw\_transaction_)[](#web3.eth.Eth.send_raw_transaction "Link to this definition")
...
Eth.replace\_transaction(_transaction\_hash_, _new\_transaction_)[](#web3.eth.Eth.replace_transaction "Link to this definition")
...
The `new_transaction` parameter should be a dictionary with transaction fields as required by [`send_transaction()`](#web3.eth.Eth.send_transaction "web3.eth.Eth.send_transaction"). It will be used to entirely replace the transaction of `transaction_hash` without using any of the pending transaction’s values.
...
Eth.modify\_transaction(_transaction\_hash_, _\*\*transaction\_params_)[](#web3.eth.Eth.modify_transaction "Link to this definition")
...
`transaction_params` are keyword arguments that correspond to valid transaction parameters as required by [`send_transaction()`](#web3.eth.Eth.send_transaction "web3.eth.Eth.send_transaction"). The parameter values will override the pending transaction’s values to create the replacement transaction to send.
...
Eth.sign(_account_, _data\=None_, _hexstr\=None_, _text\=None_)[](#web3.eth.Eth.sign "Link to this definition")
...
Eth.sign\_typed\_data(_account_, _jsonMessage_)[](#web3.eth.Eth.sign_typed_data "Link to this definition")
...
Eth.call(_transaction_, _block\_identifier\=web3.eth.default\_block_, _state\_override\=None_, _ccip\_read\_enabled\=True_)[](#web3.eth.Eth.call "Link to this definition")
...
Eth.fee\_history(_block\_count_, _newest\_block_, _reward\_percentiles\=None_)[](#web3.eth.Eth.fee_history "Link to this definition")
...
*   **oldestBlock** _(int)_ – The oldest, lowest-numbered, block in the range requested as a `BlockNumber` type with [`int`](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") value.
    
*   **baseFeePerGas** _(List\[Wei\])_ – An array of block base fees per gas. This includes the next block after the newest of the returned range, because this value can be derived from the newest block. Zeroes are returned for pre-EIP-1559 blocks.
    
*   **gasUsedRatio** _(List\[float\])_ – An array of `gasUsed`/`gasLimit` float values for the requested blocks.
    
*   **reward** _(List\[List\[Wei\]\])_ – _(optional)_ A two-dimensional array of effective priority fees per gas at the requested block percentiles.
...
Eth.estimate\_gas(_transaction_, _block\_identifier\=None_, _state\_override\=None_)[](#web3.eth.Eth.estimate_gas "Link to this definition")
...
Eth.generate\_gas\_price(_transaction\_params\=None_)[](#web3.eth.Eth.generate_gas_price "Link to this definition")
...
Eth.set\_gas\_price\_strategy(_gas\_price\_strategy_)[](#web3.eth.Eth.set_gas_price_strategy "Link to this definition")
...
Eth.subscribe(_subscription\_identifier_, _subscription\_params_)[](#web3.eth.Eth.subscribe "Link to this definition")
...
Eth.unsubscribe(_subscription\_id_)[](#web3.eth.Eth.unsubscribe "Link to this definition")
...
Eth.filter(_filter\_params_)[](#web3.eth.Eth.filter "Link to this definition")
...
Eth.get\_filter\_changes(_self_, _filter\_id_)[](#web3.eth.Eth.get_filter_changes "Link to this definition")
...
Eth.get\_filter\_logs(_self_, _filter\_id_)[](#web3.eth.Eth.get_filter_logs "Link to this definition")
...
Eth.uninstall\_filter(_self_, _filter\_id_)[](#web3.eth.Eth.uninstall_filter "Link to this definition")
...
Eth.get\_logs(_filter\_params_)[](#web3.eth.Eth.get_logs "Link to this definition")
...
Eth.contract(_address\=None_, _contract\_name\=None_, _ContractFactoryClass\=Contract_, _\*\*contract\_factory\_kwargs_)[](#web3.eth.Eth.contract "Link to this definition")
...
*   **abi** (_ABI_) – Application Binary Interface. Usually provided since an `abi` is required to interact with any contract.
...
*   **bytecode\_runtime** – Bytecode stored at the contract address, excludes the constructor and initialization code
    
*   **clone\_bin**
    
*   **dev\_doc**
    
*   **decode\_tuples** – Optionally convert tuples/structs to named tuples
...
*   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.13)") – If the address is not provided
    
*   [**AttributeError**](https://docs.python.org/3/library/exceptions.html#AttributeError "(in Python v3.13)") – If the contract class is not initialized
...
Eth.set\_contract\_factory(_contractFactoryClass_)[](#web3.eth.Eth.set_contract_factory "Link to this definition")
...
<page>
  <title>Net API — web3.py 7.7.0 documentation</title>
...
web3.net.listening()[](#web3.net.listening "Link to this definition")
...
web3.net.peer\_count()[](#web3.net.peer_count "Link to this definition")
...
web3.net.version()[](#web3.net.version "Link to this definition")
...
<page>
  <title>Beacon API — web3.py 7.7.0 documentation</title>
...
Beacon.get\_genesis()[](#Beacon.get_genesis "Link to this definition")
...
Beacon.get\_hash\_root(_state\_id\='head'_)[](#Beacon.get_hash_root "Link to this definition")
...
Beacon.get\_fork\_data(_state\_id\='head'_)[](#Beacon.get_fork_data "Link to this definition")
...
Beacon.get\_finality\_checkpoint(_state\_id\='head'_)[](#Beacon.get_finality_checkpoint "Link to this definition")
...
Beacon.get\_validators(_state\_id\='head'_)[](#Beacon.get_validators "Link to this definition")
...
Beacon.get\_validator(_validator\_id_, _state\_id\='head'_)[](#Beacon.get_validator "Link to this definition")
...
Beacon.get\_validator\_balances(_state\_id\='head'_)[](#Beacon.get_validator_balances "Link to this definition")
...
Beacon.get\_epoch\_committees(_state\_id\='head'_)[](#Beacon.get_epoch_committees "Link to this definition")
...
Beacon.get\_block(_block\_id_)[](#Beacon.get_block "Link to this definition")
...
Beacon.get\_block\_root(_block\_id_)[](#Beacon.get_block_root "Link to this definition")
...
Beacon.get\_block\_attestations(_block\_id_)[](#Beacon.get_block_attestations "Link to this definition")
...
Beacon.get\_attestations()[](#Beacon.get_attestations "Link to this definition")

\>>> beacon.get\_attestations()
{'data': \[\]}

Beacon.get\_attester\_slashings()[](#Beacon.get_attester_slashings "Link to this definition")

\>>> beacon.get\_attester\_slashings()
{'data': \[\]}

Beacon.get\_proposer\_slashings()[](#Beacon.get_proposer_slashings "Link to this definition")

\>>> beacon.get\_proposer\_slashings()
{'data': \[\]}

Beacon.get\_voluntary\_exits()[](#Beacon.get_voluntary_exits "Link to this definition")

\>>> beacon.get\_voluntary\_exits()
{'data': \[\]}

Beacon.get\_fork\_schedule()[](#Beacon.get_fork_schedule "Link to this definition")
...
Beacon.get\_spec()[](#Beacon.get_spec "Link to this definition")
...
Beacon.get\_deposit\_contract()[](#Beacon.get_deposit_contract "Link to this definition")
...
Beacon.get\_beacon\_state(_state\_id\='head'_)[](#Beacon.get_beacon_state "Link to this definition")
...
Beacon.get\_beacon\_heads()[](#Beacon.get_beacon_heads "Link to this definition")
...
Beacon.get\_blob\_sidecars(_block\_id_, _indices\=\[\]_)[](#Beacon.get_blob_sidecars "Link to this definition")
...
Beacon.get\_node\_identity()[](#Beacon.get_node_identity "Link to this definition")
...
Beacon.get\_peers()[](#Beacon.get_peers "Link to this definition")
...
Beacon.get\_peer(_peer\_id_)[](#Beacon.get_peer "Link to this definition")
...
Beacon.get\_health()[](#Beacon.get_health "Link to this definition")

\>>> beacon.get\_health()
200

Beacon.get\_version()[](#Beacon.get_version "Link to this definition")
...
Beacon.get\_syncing()[](#Beacon.get_syncing "Link to this definition")
...
<page>
  <title>Tracing API — web3.py 7.7.0 documentation</title>
...
web3.tracing.trace\_replay\_transaction()[](#web3.tracing.trace_replay_transaction "Link to this definition")

web3.tracing.trace\_replay\_block\_transactions()[](#web3.tracing.trace_replay_block_transactions "Link to this definition")

web3.tracing.trace\_filter()[](#web3.tracing.trace_filter "Link to this definition")

web3.tracing.trace\_block()[](#web3.tracing.trace_block "Link to this definition")

web3.tracing.trace\_transaction()[](#web3.tracing.trace_transaction "Link to this definition")

web3.tracing.trace\_call()[](#web3.tracing.trace_call "Link to this definition")

web3.tracing.trace\_raw\_transaction()[](#web3.tracing.trace_raw_transaction "Link to this definition")</content>
</page>

<page>
  <title>Geth API — web3.py 7.7.0 documentation</title>
...
GethAdmin API[](#gethadmin-api "Link to this heading")
-------------------------------------------------------
...
web3.geth.admin.datadir()[](#web3.geth.admin.datadir "Link to this definition")
...
web3.geth.admin.node\_info()[](#web3.geth.admin.node_info "Link to this definition")
...
web3.geth.admin.peers()[](#web3.geth.admin.peers "Link to this definition")
...
web3.geth.admin.add\_peer(_node\_url_)[](#web3.geth.admin.add_peer "Link to this definition")
...
web3.geth.admin.start\_http(_host\='localhost'_, _port\=8545_, _cors\=''_, _apis\='eth,net,web3'_)[](#web3.geth.admin.start_http "Link to this definition")
...
web3.geth.admin.start\_ws(_host\='localhost'_, _port\=8546_, _cors\=''_, _apis\='eth,net,web3'_)[](#web3.geth.admin.start_ws "Link to this definition")
...
web3.geth.admin.stop\_http()[](#web3.geth.admin.stop_http "Link to this definition")
...
web3.geth.admin.stop\_ws()[](#web3.geth.admin.stop_ws "Link to this definition")
...
GethTxPool API[](#gethtxpool-api "Link to this heading")
---------------------------------------------------------
...
TxPool.inspect()[](#web3.geth.txpool.TxPool.inspect "Link to this definition")
...
TxPool.status()[](#web3.geth.txpool.TxPool.status "Link to this definition")
...
TxPool.content()[](#web3.geth.txpool.TxPool.content "Link to this definition")
...
GethDebug API[](#gethdebug-api "Link to this heading")
-------------------------------------------------------
...
Debug.trace\_transaction(_transaction\_hash_)[](#web3.geth.debug.Debug.trace_transaction "Link to this definition")
...
<page>
  <title>Utils — web3.py 7.7.0 documentation</title>
...
ABI[](#module-web3.utils.abi "Link to this heading")
-----------------------------------------------------
...
*   **abi\_element\_identifier** (ABIElementIdentifier) – Find an element ABI with matching identifier.
    
*   **args** (Optional\[Sequence\[Any\]\]) – Find a function ABI with matching args.
    
*   **abi\_codec** (Optional\[Any\]) – Codec used for encoding and decoding. Default with strict\_bytes\_type\_checking enabled.
...
*   **abi\_element\_identifier** (ABIElementIdentifier) – Find an element ABI with matching identifier. The identifier may be a function name, signature, or `FallbackFn` or `ReceiveFn`. A function signature is in the form `name(arg1Type,arg2Type,...)`.
...
*   **event\_name** (str) – Find an event abi with matching event name.
    
*   **argument\_names** (Optional\[Sequence\[str\]\]) – Find an event abi with matching arguments.
...
web3.utils.abi.get\_event\_log\_topics(_event\_abi: ABIEvent_, _topics: [Sequence](https://docs.python.org/3/library/typing.html#typing.Sequence "(in Python v3.13)")\[[HexBytes](https://hexbytes.readthedocs.io/en/latest/hexbytes.html#hexbytes.main.HexBytes "(in HexBytes v1.3)")\]_) → [Sequence](https://docs.python.org/3/library/typing.html#typing.Sequence "(in Python v3.13)")\[[HexBytes](https://hexbytes.readthedocs.io/en/latest/hexbytes.html#hexbytes.main.HexBytes "(in HexBytes v1.3)")\][](#web3.utils.abi.get_event_log_topics "Link to this definition")

Return topics for an event ABI.

Parameters:

*   **event\_abi** (ABIEvent) – Event ABI.
...
utils.get\_create\_address(_sender_, _nonce_)[](#web3.utils.abi.utils.get_create_address "Link to this definition")

Return the checksummed contract address generated by using the `CREATE` opcode by a sender address with a given nonce.

utils.get\_create2\_address(_sender_, _salt_, _init\_code_)[](#web3.utils.abi.utils.get_create2_address "Link to this definition")
...
_class_ utils.SimpleCache[](#web3.utils.abi.utils.SimpleCache "Link to this definition")
...
utils.handle\_offchain\_lookup(_offchain\_lookup\_payload_, _transaction_)[](#web3.utils.abi.utils.handle_offchain_lookup "Link to this definition")
...
utils.async\_handle\_offchain\_lookup(_offchain\_lookup\_payload_, _transaction_)[](#web3.utils.abi.utils.async_handle_offchain_lookup "Link to this definition")

The async version of the `handle_offchain_lookup()` utility method described above.</content>
</page>

<page>
  <title>Gas Price API — web3.py 7.7.0 documentation</title>
...
Retrieving gas price[](#retrieving-gas-price "Link to this heading")
---------------------------------------------------------------------
...
Creating a gas price strategy[](#creating-a-gas-price-strategy "Link to this heading")
---------------------------------------------------------------------------------------
...
Selecting the gas price strategy[](#selecting-the-gas-price-strategy "Link to this heading")
---------------------------------------------------------------------------------------------
...
Available gas price strategies[](#module-web3.gas_strategies.rpc "Link to this heading")
-----------------------------------------------------------------------------------------

web3.gas\_strategies.rpc.rpc\_gas\_price\_strategy(_web3_, _transaction\_params\=None_)[](#web3.gas_strategies.rpc.rpc_gas_price_strategy "Link to this definition")
...
web3.gas\_strategies.time\_based.construct\_time\_based\_gas\_price\_strategy(_max\_wait\_seconds_, _sample\_size\=120_, _probability\=98_, _weighted\=False_)[](#web3.gas_strategies.time_based.construct_time_based_gas_price_strategy "Link to this definition")
...
<page>
  <title>ENS API — web3.py 7.7.0 documentation</title>
...
_classmethod_ from\_web3(_w3: [Web3](https://web3py.readthedocs.io/en/stable/web3.main.html#web3.Web3 "web3.Web3")_, _addr: ChecksumAddress \= None_) → [ENS](#ens.ens.ENS "ens.ens.ENS")[](#ens.ens.ENS.from_web3 "Link to this definition")

Generate an ENS instance from a Web3 instance

Parameters:

*   **w3** ([_web3.Web3_](https://web3py.readthedocs.io/en/stable/web3.main.html#web3.Web3 "web3.Web3")) – to infer connection, middleware, and codec information
    
*   **addr** (_hex-string_) – the address of the ENS registry on-chain. If not provided, defaults to the mainnet ENS registry address.
    

address(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _coin\_type: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") \= None_) → ChecksumAddress | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)")[](#ens.ens.ENS.address "Link to this definition")

Look up the Ethereum address that name currently points to.

Parameters:

*   **name** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – an ENS name to look up
    
*   **coin\_type** ([_int_](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")) – if provided, look up the address for this coin type
    

Raises:

*   [**InvalidName**](#ens.exceptions.InvalidName "ens.exceptions.InvalidName") – if name has invalid syntax
    
*   [**ResolverNotFound**](#ens.exceptions.ResolverNotFound "ens.exceptions.ResolverNotFound") – if no resolver found for name
    
*   [**UnsupportedFunction**](#ens.exceptions.UnsupportedFunction "ens.exceptions.UnsupportedFunction") – if the resolver does not support the `addr()` function
    

setup\_address(_name: str_, _address: Address | ChecksumAddress | HexAddress \= <object object>_, _coin\_type: int | None \= None_, _transact: TxParams | None \= None_) → [HexBytes](https://hexbytes.readthedocs.io/en/latest/hexbytes.html#hexbytes.main.HexBytes "(in HexBytes v1.3)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)")[](#ens.ens.ENS.setup_address "Link to this definition")
...
*   **name** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – ENS name to set up
    
*   **address** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – name will point to this address, in checksum format. If `None`, erase the record. If not specified, name will point to the owner’s address.
    
*   **coin\_type** ([_int_](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")) – if provided, set up the address for this coin type
    
*   **transact** ([_dict_](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)")) – the transaction configuration, like in [`send_transaction()`](https://web3py.readthedocs.io/en/stable/web3.eth.html#web3.eth.Eth.send_transaction "web3.eth.Eth.send_transaction")
...
*   [**UnauthorizedError**](#ens.exceptions.UnauthorizedError "ens.exceptions.UnauthorizedError") – if `'from'` in transact does not own name
    

name(_address: ChecksumAddress_) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)")[](#ens.ens.ENS.name "Link to this definition")
...
setup\_name(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _address: ChecksumAddress | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") \= None_, _transact: TxParams | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") \= None_) → [HexBytes](https://hexbytes.readthedocs.io/en/latest/hexbytes.html#hexbytes.main.HexBytes "(in HexBytes v1.3)")[](#ens.ens.ENS.setup_name "Link to this definition")
...
*   **name** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – ENS name that address will point to
    
*   **address** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – address to set up, in checksum format
    
*   **transact** ([_dict_](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)")) – the transaction configuration, like in `send_transaction()`
    

Raises:

*   [**AddressMismatch**](#ens.exceptions.AddressMismatch "ens.exceptions.AddressMismatch") – if the name does not already point to the address
    
*   [**InvalidName**](#ens.exceptions.InvalidName "ens.exceptions.InvalidName") – if name has invalid syntax
    
*   [**UnauthorizedError**](#ens.exceptions.UnauthorizedError "ens.exceptions.UnauthorizedError") – if `'from'` in transact does not own name
    
*   [**UnownedName**](#ens.exceptions.UnownedName "ens.exceptions.UnownedName") – if no one owns name
    

owner(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_) → ChecksumAddress[](#ens.ens.ENS.owner "Link to this definition")

Get the owner of a name. Note that this may be different from the deed holder in the ‘.eth’ registrar. Learn more about the difference between deed and name ownership in the ENS [Managing Ownership docs](http://docs.ens.domains/en/latest/userguide.html#managing-ownership)

Parameters:

**name** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – ENS name to look up
...
setup\_owner(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _new\_owner: ChecksumAddress \= None_, _transact: TxParams | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") \= None_) → ChecksumAddress | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)")[](#ens.ens.ENS.setup_owner "Link to this definition")

Set the owner of the supplied name to new\_owner.

For typical scenarios, you’ll never need to call this method directly, simply call [`setup_name()`](#ens.ens.ENS.setup_name "ens.ens.ENS.setup_name") or [`setup_address()`](#ens.ens.ENS.setup_address "ens.ens.ENS.setup_address"). This method does _not_ set up the name to point to an address.
...
resolver(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_) → [Contract](https://web3py.readthedocs.io/en/stable/web3.contract.html#web3.contract.Contract "web3.contract.Contract") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)")[](#ens.ens.ENS.resolver "Link to this definition")

Get the resolver for an ENS name.

Parameters:

**name** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – The ENS name

get\_text(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _key: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")[](#ens.ens.ENS.get_text "Link to this definition")
...
*   **key** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – ENS name’s text record key
...
*   [**UnsupportedFunction**](#ens.exceptions.UnsupportedFunction "ens.exceptions.UnsupportedFunction") – If the resolver does not support the “0x59d1d43c” interface id
    
*   [**ResolverNotFound**](#ens.exceptions.ResolverNotFound "ens.exceptions.ResolverNotFound") – If no resolver is found for the provided name
    

set\_text(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _key: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _transact: TxParams \= None_) → [HexBytes](https://hexbytes.readthedocs.io/en/latest/hexbytes.html#hexbytes.main.HexBytes "(in HexBytes v1.3)")[](#ens.ens.ENS.set_text "Link to this definition")

Set the value of a text record of an ENS name.

Parameters:

*   **name** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – ENS name
    
*   **key** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – Name of the attribute to set
    
*   **value** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – Value to set the attribute to
...
ens.async\_ens module[](#module-ens.async_ens "Link to this heading")
----------------------------------------------------------------------

_class_ ens.async\_ens.AsyncENS(_provider: AsyncBaseProvider \= None_, _addr: ChecksumAddress \= None_, _middleware: [Sequence](https://docs.python.org/3/library/typing.html#typing.Sequence "(in Python v3.13)")\[[Tuple](https://docs.python.org/3/library/typing.html#typing.Tuple "(in Python v3.13)")\[Middleware, [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")\]\] | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") \= None_)[](#ens.async_ens.AsyncENS "Link to this definition")

Quick access to common Ethereum Name Service functions, like getting the address for a name.

Unless otherwise specified, all addresses are assumed to be a str in [checksum format](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-155.md), # blocklint: pragma # noqa: E501 like: `"0x314159265dD8dbb310642f98f50C066173C1259b"`

_classmethod_ from\_web3(_w3: AsyncWeb3_, _addr: ChecksumAddress \= None_) → [AsyncENS](#ens.async_ens.AsyncENS "ens.async_ens.AsyncENS")[](#ens.async_ens.AsyncENS.from_web3 "Link to this definition")

Generate an AsyncENS instance with web3

Parameters:

*   **w3** ([_web3.Web3_](https://web3py.readthedocs.io/en/stable/web3.main.html#web3.Web3 "web3.Web3")) – to infer connection information
    
*   **addr** (_hex-string_) – the address of the ENS registry on-chain. If not provided, defaults to the mainnet ENS registry address.
    

_async_ address(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _coin\_type: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") \= None_) → ChecksumAddress | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)")[](#ens.async_ens.AsyncENS.address "Link to this definition")
...
_async_ name(_address: ChecksumAddress_) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)")[](#ens.async_ens.AsyncENS.name "Link to this definition")
...
_async_ setup\_name(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _address: ChecksumAddress | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") \= None_, _transact: TxParams | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") \= None_) → [HexBytes](https://hexbytes.readthedocs.io/en/latest/hexbytes.html#hexbytes.main.HexBytes "(in HexBytes v1.3)")[](#ens.async_ens.AsyncENS.setup_name "Link to this definition")
...
_async_ owner(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_) → ChecksumAddress[](#ens.async_ens.AsyncENS.owner "Link to this definition")
...
_async_ setup\_owner(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _new\_owner: ChecksumAddress \= None_, _transact: TxParams | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") \= None_) → ChecksumAddress | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)")[](#ens.async_ens.AsyncENS.setup_owner "Link to this definition")

Set the owner of the supplied name to new\_owner.

For typical scenarios, you’ll never need to call this method directly, simply call [`setup_name()`](#ens.async_ens.AsyncENS.setup_name "ens.async_ens.AsyncENS.setup_name") or [`setup_address()`](#ens.async_ens.AsyncENS.setup_address "ens.async_ens.AsyncENS.setup_address"). This method does _not_ set up the name to point to an address.
...
_async_ resolver(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_) → AsyncContract | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)")[](#ens.async_ens.AsyncENS.resolver "Link to this definition")
...
_async_ get\_text(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _key: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")[](#ens.async_ens.AsyncENS.get_text "Link to this definition")
...
_async_ set\_text(_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _key: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")_, _transact: TxParams \= None_) → [HexBytes](https://hexbytes.readthedocs.io/en/latest/hexbytes.html#hexbytes.main.HexBytes "(in HexBytes v1.3)")[](#ens.async_ens.AsyncENS.set_text "Link to this definition")
...
*   **key** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – The name of the attribute to set
...
ens.exceptions module[](#module-ens.exceptions "Link to this heading")
-----------------------------------------------------------------------

_exception_ ens.exceptions.ENSException[](#ens.exceptions.ENSException "Link to this definition")

Bases: [`Exception`](https://docs.python.org/3/library/exceptions.html#Exception "(in Python v3.13)")

Base class for all ENS Errors

_exception_ ens.exceptions.ENSValueError[](#ens.exceptions.ENSValueError "Link to this definition")
...
_exception_ ens.exceptions.ENSTypeError[](#ens.exceptions.ENSTypeError "Link to this definition")
...
_exception_ ens.exceptions.AddressMismatch[](#ens.exceptions.AddressMismatch "Link to this definition")
...
_exception_ ens.exceptions.InvalidName[](#ens.exceptions.InvalidName "Link to this definition")
...
_exception_ ens.exceptions.UnownedName[](#ens.exceptions.UnownedName "Link to this definition")
...
_exception_ ens.exceptions.ResolverNotFound[](#ens.exceptions.ResolverNotFound "Link to this definition")

Bases: [`ENSException`](#ens.exceptions.ENSException "ens.exceptions.ENSException")

Raised if no resolver was found for the name you are trying to resolve.

_exception_ ens.exceptions.UnsupportedFunction[](#ens.exceptions.UnsupportedFunction "Link to this definition")

Bases: [`ENSException`](#ens.exceptions.ENSException "ens.exceptions.ENSException")

Raised if a resolver does not support a particular method.

_exception_ ens.exceptions.BidTooLow[](#ens.exceptions.BidTooLow "Link to this definition")

Bases: [`ENSException`](#ens.exceptions.ENSException "ens.exceptions.ENSException")

Raised if you bid less than the minimum amount

_exception_ ens.exceptions.InvalidBidHash[](#ens.exceptions.InvalidBidHash "Link to this definition")

Bases: [`ENSException`](#ens.exceptions.ENSException "ens.exceptions.ENSException")

Raised if you supply incorrect data to generate the bid hash.

_exception_ ens.exceptions.InvalidLabel[](#ens.exceptions.InvalidLabel "Link to this definition")

Bases: [`ENSException`](#ens.exceptions.ENSException "ens.exceptions.ENSException")

Raised if you supply an invalid label

_exception_ ens.exceptions.OversizeTransaction[](#ens.exceptions.OversizeTransaction "Link to this definition")
...
_exception_ ens.exceptions.UnderfundedBid[](#ens.exceptions.UnderfundedBid "Link to this definition")

Bases: [`ENSException`](#ens.exceptions.ENSException "ens.exceptions.ENSException")

Raised if you send less wei with your bid than you declared as your intent to bid.

_exception_ ens.exceptions.ENSValidationError[](#ens.exceptions.ENSValidationError "Link to this definition")
...
<page>
  <title>Constants — web3.py 7.7.0 documentation</title>
...
<page>
  <title>Resources and Learning Material — web3.py 7.7.0 documentation</title>
  <url>https://web3py.readthedocs.io/en/stable/resources.html</url>
  <content>web3.py and the Ethereum Python ecosystem have an active community of developers and educators. Here you’ll find libraries, tutorials, examples, courses and other learning material.
...
*   [A Developer’s Guide to Ethereum, Pt. 1](https://snakecharmers.ethereum.org/a-developers-guide-to-ethereum-pt-1/)
...
Conference Presentations and Videos[](#conference-presentations-and-videos "Link to this heading")
---------------------------------------------------------------------------------------------------
...
Smart Contract Programming Languages[](#smart-contract-programming-languages "Link to this heading")
-----------------------------------------------------------------------------------------------------

*   [Vyper](https://docs.vyperlang.org/en/stable/) - Contract-oriented, pythonic programming language that targets EVM
    

Frameworks and Tooling[](#frameworks-and-tooling "Link to this heading")
-------------------------------------------------------------------------
...
*   [Lido Python SDK](https://github.com/lidofinance/lido-python-sdk) - Library with which you can get all Lido validator’s signatures and check their validity
...
Hackathon Helpers[](#hackathon-helpers "Link to this heading")
---------------------------------------------------------------
...
<page>
  <title>Contributing — web3.py 7.7.0 documentation</title>
...
How to Help[](#how-to-help "Link to this heading")
---------------------------------------------------
...
Your Development Environment[](#your-development-environment "Link to this heading")
-------------------------------------------------------------------------------------
...
### Unit Testing and eth-tester Tests[](#unit-testing-and-eth-tester-tests "Link to this heading")
...
### Integration Testing[](#integration-testing "Link to this heading")
...
### Working With Test Contracts[](#working-with-test-contracts "Link to this heading")
...
Manual Testing[](#manual-testing "Link to this heading")
---------------------------------------------------------
...
See GitHub’s documentation for [working on pull requests](https://help.github.com/articles/about-pull-requests/).
...
Generating New Fixtures[](#generating-new-fixtures "Link to this heading")
---------------------------------------------------------------------------
...
### Geth Fixtures[](#geth-fixtures "Link to this heading")
...
### CI Testing With a Nightly Geth Build[](#ci-testing-with-a-nightly-geth-build "Link to this heading")
...
5.  In `.circleci/config.yml`, update the `geth_version` pipeline parameter to “custom”. This will trigger the custom Geth build to be used in the CI test suite.
...
### Final Test Before Each Release[](#final-test-before-each-release "Link to this heading")
...
### Verify The Latest Documentation[](#verify-the-latest-documentation "Link to this heading")

To preview the documentation that will get published:

### Preview The Release Notes[](#preview-the-release-notes "Link to this heading")

$ towncrier build \--draft

### Compile The Release Notes[](#compile-the-release-notes "Link to this heading")
...
### Push The Release to GitHub & PyPI[](#push-the-release-to-github-pypi "Link to this heading")
...
### Which Version Part to Bump[](#which-version-part-to-bump "Link to this heading")
...
<page>
  <title>Code of Conduct — web3.py 7.7.0 documentation</title>
  <url>https://web3py.readthedocs.io/en/stable/code_of_conduct.html</url>
  <content>Our Pledge[](#our-pledge "Link to this heading")
-------------------------------------------------

In the interest of fostering an open and welcoming environment, we as contributors and maintainers pledge to make participation in our project and our community a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.

Our Standards[](#our-standards "Link to this heading")
-------------------------------------------------------
...
Our Responsibilities[](#our-responsibilities "Link to this heading")
---------------------------------------------------------------------
...
Enforcement[](#enforcement "Link to this heading")
---------------------------------------------------
...
<page>
  <title>Index — web3.py 7.7.0 documentation</title>
...
<page>
  <title>Python Module Index — web3.py 7.7.0 documentation</title>
...
<page>
  <title>Search — web3.py 7.7.0 documentation</title>
